#ifndef _gkg_core_io_StdVectorBSwapItemWriter_i_h_
#define _gkg_core_io_StdVectorBSwapItemWriter_i_h_
...
template < class T >
inline
gkg::StdVectorBSwapItemWriter< T >::StdVectorBSwapItemWriter()
...
template < class T >
inline
void gkg::StdVectorBSwapItemWriter< T >::write( std::ostream& os,
...
template < class T >
inline
void gkg::StdVectorBSwapItemWriter< T >::write( gkg::largefile_ofstream& os,
                                              const std::vector< T >* pItem,
                                              size_t count ) const
{
...
template < class T >
inline
void gkg::StdVectorBSwapItemWriter< T >::write( gkg::largefile_fstream& fs,
                                              const std::vector< T >* pItem,
                                              size_t count ) const
{
...
template <>
inline
void gkg::StdVectorBSwapItemWriter< bool >::write( 
                                               std::ostream& os,
                                               ...
                                               size_t count ) const
{
  ...
  gkg::ItemWriter< bool >& itemW2 =
    gkg::DefaultItemIOFactory< bool >::getInstance().getWriter( false, true );
