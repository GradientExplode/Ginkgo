#ifndef _gkg_core_io_StdVectorBinaryItemWriter_i_h_
#define _gkg_core_io_StdVectorBinaryItemWriter_i_h_
...
template < class T >
inline
gkg::StdVectorBinaryItemWriter< T >::StdVectorBinaryItemWriter()
...
template < class T >
inline
void gkg::StdVectorBinaryItemWriter< T >::write( std::ostream& os,
...
template < class T >
inline
void gkg::StdVectorBinaryItemWriter< T >::write( gkg::largefile_ofstream& os,
                                              const std::vector< T >* pItem,
                                              size_t count ) const
{
...
template < class T >
inline
void gkg::StdVectorBinaryItemWriter< T >::write( gkg::largefile_fstream& fs,
                                              const std::vector< T >* pItem,
                                              size_t count ) const
{
...
template <>
inline
void gkg::StdVectorBinaryItemWriter< bool >::write( 
                                               std::ostream& os,
                                               ...
                                               size_t count ) const
{
  ...
  gkg::ItemWriter< bool >& itemW2 =
    gkg::DefaultItemIOFactory< bool >::getInstance().getWriter( false, false );
