...
// !!! erreur a corriger qd subpixel m2 n2
...
/*
if ( ( i % 100 == 0 ) && ( l % 100 == 0 ) && ( j1 % 100 == 0 ) )
{
  std::cout << " cost1[ l ] before "  << cost1[ l ] << std::endl;
}
*/
          cost1[ l ] += std::abs( ( float )( reference( yy, xx, zz) - 
                                interpolatedFloating( yy2, xx2, zz2 ) ) );
...
if ( ( i % 100 == 0 ) && ( l % 100 == 0 ) && ( j1 % 100 == 0 ) )
{
  ...
  std::cout << " reference( yy, xx, zz)"  << reference( yy, xx, zz) << std::endl;
  std::cout << " interpolatedFloating( yy2, xx2, zz2 ) "  << interpolatedFloating( yy2, xx2, zz2 ) << std::endl;
  std::cout << " std::abs "  << std::abs( ( float )( reference( yy, xx, zz) - 
                                interpolatedFloating( yy2, xx2, zz2 ) ) ) << std::endl;
...
*/
      ...
      for ( l = 0; l < cubedCurrentSearchSpace; ++l )
      {
        ...
        totalCost[ i + l * currentSize ] = regularizationWeighting2 * 
                                                                    cost1[ l ];
        //if ( ( i % 100 == 0 ) && ( l % 100 == 0 ) )
        //std::cout << "totalCost[ i + l * currentSize ] : "  << totalCost[ i + l * currentSize ] << std::endl;
