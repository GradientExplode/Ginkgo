#ifndef _gkg_graphics_QtGL_plugin_functors_Voi_AxialStrategy_h_
#define _gkg_graphics_QtGL_plugin_functors_Voi_AxialStrategy_h_
...
class VoiAxialStrategy : public Voi2DStrategy
{
