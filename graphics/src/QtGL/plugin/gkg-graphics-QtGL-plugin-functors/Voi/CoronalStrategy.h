#ifndef _gkg_graphics_QtGL_plugin_functors_Voi_CoronalStrategy_h_
#define _gkg_graphics_QtGL_plugin_functors_Voi_CoronalStrategy_h_
...
class VoiCoronalStrategy : public Voi2DStrategy
{
