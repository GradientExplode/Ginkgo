...
gkg::TileFirstAligned::TileFirstAligned( gkg::DimensionName dimensionName)
                      : gkg::Layout(),
...
gkg::TileFirstAligned::~TileFirstAligned()
{
}


void gkg::TileFirstAligned::request(
  ...
  for ( int32_t index = 0; index < count; index++ )
  {
    ...
    if ( geometryRequirement.isDefined() )
    {
      ...
      else
      {
        ...
        naturalTrail += geometryRequirement.getNatural();
        maxTrail += geometryRequirement.getNatural() +
                    geometryRequirement.getStretch();
        minTrail += geometryRequirement.getNatural() -
                    geometryRequirement.getShrink();
...
void gkg::TileFirstAligned::allocate(
