#ifndef _gkg_graphics_X11_core_TBAutoScrollBox_h_
#define _gkg_graphics_X11_core_TBAutoScrollBox_h_
...
class TBAutoScrollBox : public Patch
{

  public:

    TBAutoScrollBox( bool shrinkable );
