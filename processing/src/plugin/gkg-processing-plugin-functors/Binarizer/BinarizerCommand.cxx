#include <gkg-processing-plugin-functors/Binarizer/BinarizerCommand.h>
...
//
// class BinarizerCommand
//


gkg::BinarizerCommand::BinarizerCommand( int32_t argc,
                                         char* argv[],
                                         bool loadPlugin,
                                         bool removeFirst )
                                     ...
                                     loadPlugin, removeFirst )
{
  ...
  GKG_CATCH( "gkg::BinarizerCommand::BinarizerCommand( "
...
gkg::BinarizerCommand::BinarizerCommand( const std::string& fileNameIn,
                      			 ...
                      			 bool verbose )
{
  ...
  try
  {
    ...
    execute( fileNameIn, fileNameOut, outType, mode,
             threshold1, threshold2, foreground, background,
...
gkg::BinarizerCommand::BinarizerCommand( const gkg::Dictionary& parameters )
...
gkg::BinarizerCommand::~BinarizerCommand()
{
}


std::string gkg::BinarizerCommand::getStaticName()
{
  ...
  GKG_CATCH( "std::string gkg::BinarizerCommand::getStaticName()" );

}


void gkg::BinarizerCommand::parse()
{
  ...
  GKG_CATCH_FUNCTOR( "void gkg::BinarizerCommand::parse()" );

}


void gkg::BinarizerCommand::execute( const std::string& fileNameIn,
                      		     const std::string& fileNameOut,
                      		     const std::string& outType,
                      		     const std::string& mode,
                      		     double threshold1,
                      		     ...
                      		     bool verbose )
{
  ...
  GKG_CATCH( "void gkg::BinarizerCommand::execute( "
             "const std::string& fileNameIn, "
             "const std::string& fileNameOut, "
             "const std::string& outType, "
             "const std::string& mode, "
...
RegisterCommandCreator( BinarizerCommand,
