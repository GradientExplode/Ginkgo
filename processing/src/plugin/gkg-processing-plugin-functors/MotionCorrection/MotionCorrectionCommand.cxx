#include <gkg-processing-plugin-functors/MotionCorrection/MotionCorrectionCommand.h>
...
//
// class MotionCorrectionProcess
//


class MotionCorrectionProcess : public gkg::Process
{

  public:

    MotionCorrectionProcess(
...
MotionCorrectionProcess::MotionCorrectionProcess(
     const int32_t& theReferenceRank,
     const std::string& theReferenceName,
     const std::string& theOutputName,
     const std::string& theTransform3dName,
                          ...
                          verbose( theVerbose )
{
  ...
  GKG_CATCH( "MotionCorrectionProcess::MotionCorrectionProcess( "
             "const int32_t& theReferenceRank, "
             "const std::string& theReferenceName, "
             "const std::string& theOutputName, "
             "const std::string& theTransform3dName, "
...
template < class T >
void 
MotionCorrectionProcess::correct( gkg::Process& process,
                                  const std::string& inputName,
                                  const gkg::AnalyzedObject&,
                                  const std::string& )
{
  ...
  try
  {
    ...
    MotionCorrectionProcess&
      motionCorrectionProcess = static_cast< MotionCorrectionProcess& >(
                                                                      process );


    const int32_t& referenceRank =
      motionCorrectionProcess.referenceRank;
    const std::string& referenceName =
      motionCorrectionProcess.referenceName;
    const std::string& outputName =
      motionCorrectionProcess.outputName;
    const std::string& transform3dName =
      motionCorrectionProcess.transform3dName;
    const std::string& similarityMeasureName =
      motionCorrectionProcess.similarityMeasureName;
    const std::string& optimizerName =
      motionCorrectionProcess.optimizerName;
    const double& lowerThreshold =
      motionCorrectionProcess.lowerThreshold;
    const int32_t& registrationResamplingOrder =
      motionCorrectionProcess.registrationResamplingOrder;
    const std::list< int32_t >& subSamplingMaximumSizes =
      motionCorrectionProcess.subSamplingMaximumSizes;
    const std::vector< double >& similarityMeasureParameters =
      motionCorrectionProcess.similarityMeasureParameters;
    const std::vector< double >& optimizerParameters =
      motionCorrectionProcess.optimizerParameters;
    const std::string& transformType =
      motionCorrectionProcess.transformType;
    gkg::Vector& vectorOfInitialParameters =
      motionCorrectionProcess.vectorOfInitialParameters;
    const int32_t& outputResamplingOrder =
      motionCorrectionProcess.outputResamplingOrder;
    const double& background =
      motionCorrectionProcess.background;
    const std::string& furtherMotionName =
      motionCorrectionProcess.furtherMotionName;
    const gkg::Vector3d< int32_t >& furtherSliceCount =
      motionCorrectionProcess.furtherSliceCount;
    const bool& verboseRegistration =
      motionCorrectionProcess.verboseRegistration;
    const bool& verbose =
      motionCorrectionProcess.verbose;
  ...
  GKG_CATCH( "template < class T > "
             "void MotionCorrectionProcess::match( gkg::Process& process, "
             "const std::string& inputName, "
             "const gkg::AnalyzedObject&, "
             "const std::string& )" );
...
gkg::MotionCorrectionCommand::MotionCorrectionCommand( int32_t argc,
                                 		       char* argv[],
                                 		       bool loadPlugin,
                                 		       bool removeFirst )
                                            ...
                                            loadPlugin, removeFirst )
{
  ...
  GKG_CATCH( "gkg::MotionCorrectionCommand::MotionCorrectionCommand( "
...
gkg::MotionCorrectionCommand::MotionCorrectionCommand(
                       const std::string& inputName,
                            ...
                            : gkg::Command()
{
  ...
  try
  {
    ...
    execute( inputName, referenceRank, referenceName, outputName,
             transform3dName, similarityMeasureName, optimizerName,
             lowerThreshold, registrationResamplingOrder, 
             subSamplingMaximumSizes, similarityMeasureParameters,
             optimizerParameters, transformType, initialParameters,
             outputResamplingOrder, background, furtherMotionName,
             furtherSliceCount, verboseRegistration, verbose );

  }
  GKG_CATCH( "gkg::MotionCorrectionCommand::MotionCorrectionCommand( "
             "const std::string& inputName, int32_t referenceRank, "
             "const std::string& referenceName, "
             "std::string& outputName, "
             "const std::string& transform3dName, "
             "const std::string& similarityMeasureName, "
             "const std::string& optimizerName, double lowerThreshold, "
             "int32_t registrationResamplingOrder, "
             "std::list< int32_t >& subSamplingMaximumSizes, "
             "const std::vector< double >& similarityMeasureParameters, "
             "std::vector< double >& optimizerParameters, "
             "const std::string& transformType, "
             "const std::vector< float >& initialParameters, "
             "int32_t outputResamplingOrder, double background, "
             "const std::string& furtherMotionName, "
             "const gkg::Vector3d< int32_t >& furtherSliceCount, "
             "bool verboseRegistration, bool verbose )" );
...
std::string gkg::MotionCorrectionCommand::getStaticName()
{
  ...
  GKG_CATCH( "std::string gkg::MotionCorrectionCommand::getStaticName()" );

}


void gkg::MotionCorrectionCommand::parse()
{
  ...
  try
  {
    ...
    application.addSingleOption( "-o",
                                 "Output motion corrected 4D volume",
                                 outputName,
                                 true );
  ...
  GKG_CATCH_FUNCTOR( "void gkg::MotionCorrectionCommand::parse()" );

}


void gkg::MotionCorrectionCommand::execute(
                       const std::string& inputName,
                       int32_t referenceRank,
                       const std::string& referenceName,
                       std::string& outputName,
                       ...
                       bool verbose )
{
  ...
  try
  {
    ...
    if ( subSamplingMaximumSizes.empty() )
    {
      ...
      subSamplingMaximumSizes.push_back( 64 );
    ...
    MotionCorrectionProcess
      motionCorrectionProcess( referenceRank,
                               ...
                               verboseRegistration,
                               verbose );
    motionCorrectionProcess.execute( inputName );

  }
  GKG_CATCH( "void gkg::MotionCorrectionCommand::execute( "
             "const std::string& inputName, int32_t referenceRank, "
             "const std::string& referenceName, "
             "std::string& outputName, "
             "const std::string& transform3dName, "
