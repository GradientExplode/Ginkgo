...
int main( int argc, char* argv[] )
{
  ...
  try
  {
    ...
    rice.getValuesAt( x, y );
    
    std::cout << "v = " << v << " , sigma = " << sigma << std::endl;

    std::ofstream of( "rician.txt" );
    ...
    std::cout << "fit a Rician with a Gaussian mixture" << std::endl;
    std::cout << "====================================" << std::endl;
