...
gkg::MannWhitneyWilcoxonUTest::test( const std::vector< T >& x,
                                     const std::vector< T >& y ) const
{
  ...
  try
  {
    ...
    gkg::Vector vectorX( ( int32_t )x.size() );
    gkg::Vector vectorY( ( int32_t )y.size() );
    ...
    typename std::vector< T >::const_iterator jy = y.begin(),
                                              jye = y.end();
    int32_t j = 0;
    while ( jy != jye )
    {
    ...
    return this->test( vectorX, vectorY );

  }
  GKG_CATCH( "template < class T > "
             "gkg::MannWhitneyWilcoxonUTest::Result "
             "gkg::MannWhitneyWilcoxonUTest::test( "
...
template < class T >
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test( const std::list< T >& x,
                                     const std::list< T >& y ) const
{
  ...
  try
  {
    ...
    typename std::list< T >::const_iterator ix = x.begin(),
                                            ixe = x.end();
    int32_t i = 0;
    while ( ix != ixe )
    {
    ...
    typename std::list< T >::const_iterator jy = y.begin(),
                                            jye = y.end();
    int32_t j = 0;
    while ( jy != jye )
    {
...
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test( const gkg::Vector& x,
                                     const gkg::Vector& y ) const
{

  try
  {

    int32_t sampleCountX = x.getSize();
    int32_t sampleCountY = y.getSize();

    gkg::MannWhitneyWilcoxonUTest::Result result;

    if ( ( sampleCountX < 5 ) || ( sampleCountY < 5 ) )
    {

      result.twoTailedTestPValue = 1.0;
      result.leftTailedTestPValue = 1.0;
      result.rightTailedTestPValue = 1.0;

      return result;

    }

    int32_t totalSampleCount = sampleCountX + sampleCountY;

    std::vector< double > r( totalSampleCount );
    std::vector< int32_t > c( totalSampleCount );

    int32_t i = 0;
    for ( i = 0; i < sampleCountX; i++ )
    {
    ...
    for ( i = 0; i < sampleCountY; i++ )
    {

      r[ sampleCountX + i ] = y( i );
      c[ sampleCountX + i ] = 1;
    ...
    if ( totalSampleCount > 1 )
    {
      ...
      while ( i <= totalSampleCount );
      i = totalSampleCount - 1;
      do
      {
    ...
    int32_t tieCount = 0;
    int32_t j = 0;
    std::vector< int32_t > tieSize( totalSampleCount );
    while ( i < totalSampleCount )
    {

      j = i + 1;
      while ( j < totalSampleCount )
      {
    ...
    u = sampleCountX * sampleCountY +
        sampleCountX * ( sampleCountX + 1 ) / 2 - u;

    // computing result
    double mu = ( double )( sampleCountX * sampleCountY ) / ( double )2;
    tmp = totalSampleCount * ( totalSampleCount * totalSampleCount - 1 ) / 12;
    for ( i = 0; i < tieCount; i++ )
    {

      tmp -= tieSize[ i ] * ( tieSize[ i ] * tieSize[ i ] - 1 ) / 12;

    }
    double sigma = std::sqrt( ( double )( sampleCountX * sampleCountY ) /
    ...
    else
    {
      ...
      mp = std::exp( usigma( s,
                             sampleCountX,
                             sampleCountY ) );
      p = 1 - std::exp( usigma( s + 1 / sigma,
                                sampleCountX,
                                sampleCountY ) );

    }

    result.twoTailedTestPValue = std::max( 2 * std::min( p, mp ), 1e-4 );
    result.leftTailedTestPValue = std::max( mp, 1e-4 );
    result.rightTailedTestPValue = std::max( p, 1e-4 );

    return result;

  }
  GKG_CATCH( "gkg::MannWhitneyWilcoxonUTest::Result "
             "gkg::MannWhitneyWilcoxonUTest::test( "
             "const gkg::Vector& x, "
             "const gkg::Vector& y ) const" );
...
double gkg::MannWhitneyWilcoxonUTest::usigma( double s,
                                              int32_t n1,
                                              int32_t n2 )
{
  ...
  try
  {
    ...
    if ( std::min( n1, n2 ) == 5 )
    {
      ...
      if ( std::max( n1, n2 ) > 29 )
      {
        ...
        f1 = utbln5n30( s );
        f2 = utbln5n100( s );
        result = uninterpolate( f0, f1, f2, std::max( n1, n2 ) );
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma( "
             "double s, "
             "int32_t n1, "
             "int32_t n2 )" );
...
void gkg::MannWhitneyWilcoxonUTest::ucheb( double x,
                                           double c,
                                           double& tj,
                                           double& tj1,
                                           double& r )
{
  ...
  GKG_CATCH( "void gkg::MannWhitneyWilcoxonUTest::ucheb( "
             "double x, "
             "double c, "
             "double& tj, "
             "double& tj1, "
...
// 3-point polynomial interpolation
double gkg::MannWhitneyWilcoxonUTest::uninterpolate( double p1,
                                                     double p2,
                                                     double p3,
                                                     int32_t n )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::uninterpolate( "
             "double p1, "
             "double p2, "
             "double p3, "
             "int32_t n )" );
...
// Tail(0, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma000( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma000( "
...
// Tail(0.75, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma075( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma075( "
             "int32_t n1, int32_t n2 )" );
...
// Tail(1.5, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma150( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma150( "
             "int32_t n1, int32_t n2 )" );
...
// Tail(2.25, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma225( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma225( "
             "int32_t n1, int32_t n2 )" );
...
// Tail(3.0, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma300( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma300( "
             "int32_t n1, int32_t n2 )" );
...
// Tail(3.33, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma333( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma333( "
             "int32_t n1, int32_t n2 )" );
...
// Tail(3.66, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma367( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma367( "
             "int32_t n1, int32_t n2 )" );
...
// Tail(4.0, N1, N2)
double gkg::MannWhitneyWilcoxonUTest::usigma400( int32_t n1, int32_t n2 )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::usigma400( "
             "int32_t n1, int32_t n2 )" );
...
// Tail(S, 5, 5)
double gkg::MannWhitneyWilcoxonUTest::utbln5n5( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 2.611165e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n5( double s )" );

}


// Tail(S, 5, 6)
double gkg::MannWhitneyWilcoxonUTest::utbln5n6( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 2.738613e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n6( double s )" );

}


// Tail(S, 5, 7)
double gkg::MannWhitneyWilcoxonUTest::utbln5n7( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 2.841993e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n7( double s )" );

}


// Tail(S, 5, 8)
double gkg::MannWhitneyWilcoxonUTest::utbln5n8( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 2.927700e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n8( double s )" );

}


// Tail(S, 5, 9)
double gkg::MannWhitneyWilcoxonUTest::utbln5n9( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.000000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n9( double s )" );

}


// Tail(S, 5, 10)
double gkg::MannWhitneyWilcoxonUTest::utbln5n10( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.061862e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
...
// Tail(S, 5, 11)
double gkg::MannWhitneyWilcoxonUTest::utbln5n11( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.115427e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n11( double s )" );

}


// Tail(S, 5, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln5n12( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.162278e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n12( double s )" );

}


// Tail(S, 5, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln5n13( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.203616e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n13( double s )" );

}


// Tail(S, 5, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln5n14( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.240370e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n14( double s )" );

}


// Tail(S, 5, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln5n15( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.250000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n15( double s )" );

}


// Tail(S, 5, 16)
double gkg::MannWhitneyWilcoxonUTest::utbln5n16( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n16( double s )" );

}


// Tail(S, 5, 17)
double gkg::MannWhitneyWilcoxonUTest::utbln5n17( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n17( double s )" );

}


// Tail(S, 5, 18)
double gkg::MannWhitneyWilcoxonUTest::utbln5n18( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n18( double s )" );

}


// Tail(S, 5, 19)
double gkg::MannWhitneyWilcoxonUTest::utbln5n19( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n19( double s )" );

}


// Tail(S, 5, 20)
double gkg::MannWhitneyWilcoxonUTest::utbln5n20( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n20( double s )" );

}


// Tail(S, 5, 21)
double gkg::MannWhitneyWilcoxonUTest::utbln5n21( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n21( double s )" );

}


// Tail(S, 5, 22)
double gkg::MannWhitneyWilcoxonUTest::utbln5n22( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n22( double s )" );

}


// Tail(S, 5, 23)
double gkg::MannWhitneyWilcoxonUTest::utbln5n23( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n23( double s )" );

}


// Tail(S, 5, 24)
double gkg::MannWhitneyWilcoxonUTest::utbln5n24( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n24( double s )" );

}


// Tail(S, 5, 25)
double gkg::MannWhitneyWilcoxonUTest::utbln5n25( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n25( double s )" );

}


// Tail(S, 5, 26)
double gkg::MannWhitneyWilcoxonUTest::utbln5n26( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n26( double s )" );

}


// Tail(S, 5, 27)
double gkg::MannWhitneyWilcoxonUTest::utbln5n27( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n27( double s )" );

}


// Tail(S, 5, 28)
double gkg::MannWhitneyWilcoxonUTest::utbln5n28( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n28( double s )" );

}


// Tail(S, 5, 29)
double gkg::MannWhitneyWilcoxonUTest::utbln5n29( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n29( double s )" );

}


// Tail(S, 5, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln5n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n30( double s )" );

}


// Tail(S, 5, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln5n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln5n100( double s )" );

}


// Tail(S, 6, 6)
double gkg::MannWhitneyWilcoxonUTest::utbln6n6( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 2.882307e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n6( double s )" );

}


// Tail(S, 6, 7)
double gkg::MannWhitneyWilcoxonUTest::utbln6n7( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n7( double s )" );

}


// Tail(S, 6, 8)
double gkg::MannWhitneyWilcoxonUTest::utbln6n8( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.098387e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n8( double s )" );

}


// Tail(S, 6, 9)
double gkg::MannWhitneyWilcoxonUTest::utbln6n9( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.181981e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n9( double s )" );

}


// Tail(S, 6, 10)
double gkg::MannWhitneyWilcoxonUTest::utbln6n10( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.253957e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n10( double s )" );

}


// Tail(S, 6, 11)
double gkg::MannWhitneyWilcoxonUTest::utbln6n11( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.316625e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n11( double s )" );

}


// Tail(S, 6, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln6n12( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.371709e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n12( double s )" );

}


// Tail(S, 6, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln6n13( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.420526e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n13( double s )" );

}


// Tail(S, 6, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln6n14( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.450000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n14( double s )" );

}


// Tail(S, 6, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln6n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n15( double s )" );

}


// Tail(S, 6, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln6n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n30( double s )" );

}


// Tail(S, 6, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln6n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln6n100( double s )" );

}


// Tail(S, 7, 7)
double gkg::MannWhitneyWilcoxonUTest::utbln7n7( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.130495e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n7( double s )" );

}


// Tail(S, 7, 8)
double gkg::MannWhitneyWilcoxonUTest::utbln7n8( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n8( double s )" );

}


// Tail(S, 7, 9)
double gkg::MannWhitneyWilcoxonUTest::utbln7n9( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.334314e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n9( double s )" );

}


// Tail(S, 7, 10)
double gkg::MannWhitneyWilcoxonUTest::utbln7n10( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.415650e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n10( double s )" );

}


// Tail(S, 7, 11)
double gkg::MannWhitneyWilcoxonUTest::utbln7n11( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.486817e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n11( double s )" );

}


// Tail(S, 7, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln7n12( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.500000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n12( double s )" );

}


// Tail(S, 7, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln7n13( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n13( double s )" );

}


// Tail(S, 7, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln7n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n14( double s )" );

}


// Tail(S, 7, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln7n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n15( double s )" );

}


// Tail(S, 7, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln7n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n30( double s )" );

}


// Tail(S, 7, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln7n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln7n100( double s )" );

}


// Tail(S, 8, 8)
double gkg::MannWhitneyWilcoxonUTest::utbln8n8( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.360672e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n8( double s )" );

}


// Tail(S, 8, 9)
double gkg::MannWhitneyWilcoxonUTest::utbln8n9( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.464102e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n9( double s )" );

}


// Tail(S, 8, 10)
double gkg::MannWhitneyWilcoxonUTest::utbln8n10( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.554093e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n10( double s )" );

}


// Tail(S, 8, 11)
double gkg::MannWhitneyWilcoxonUTest::utbln8n11( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.600000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n11( double s )" );

}


// Tail(S, 8, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln8n12( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n12( double s )" );

}


// Tail(S, 8, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln8n13( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n13( double s )" );

}


// Tail(S, 8, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln8n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n14( double s )" );

}


// Tail(S, 8, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln8n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n15( double s )" );

}


// Tail(S, 8, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln8n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n30( double s )" );

}


// Tail(S, 8, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln8n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln8n100( double s )" );

}


// Tail(S, 9, 9)
double gkg::MannWhitneyWilcoxonUTest::utbln9n9( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.576237e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n9( double s )" );

}


// Tail(S, 9, 10)
double gkg::MannWhitneyWilcoxonUTest::utbln9n10( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.650000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n10( double s )" );

}


// Tail(S, 9, 11)
double gkg::MannWhitneyWilcoxonUTest::utbln9n11( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n11( double s )" );

}


// Tail(S, 9, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln9n12( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n12( double s )" );

}


// Tail(S, 9, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln9n13( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n13( double s )" );

}


// Tail(S, 9, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln9n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n14( double s )" );

}


// Tail(S, 9, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln9n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n15( double s )" );

}


// Tail(S, 9, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln9n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n30( double s )" );

}


// Tail(S, 9, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln9n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln9n100( double s )" );

}


// Tail(S, 10, 10)
double gkg::MannWhitneyWilcoxonUTest::utbln10n10( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n10( double s )" );

}


// Tail(S, 10, 11)
double gkg::MannWhitneyWilcoxonUTest::utbln10n11( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n11( double s )" );

}


// Tail(S, 10, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln10n12( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n12( double s )" );

}


// Tail(S, 10, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln10n13( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n13( double s )" );

}


// Tail(S, 10, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln10n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n14( double s )" );

}


// Tail(S, 10, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln10n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n15( double s )" );

}


// Tail(S, 10, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln10n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n30( double s )" );

}


// Tail(S, 10, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln10n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln10n100( double s )" );

}


// Tail(S, 11, 11)
double gkg::MannWhitneyWilcoxonUTest::utbln11n11( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0.0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.700000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln11n11( double s )" );

}


// Tail(S, 11, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln11n12( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln11n12( double s )" );

}


// Tail(S, 11, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln11n13( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln11n13( double s )" );

}


// Tail(S, 11, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln11n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln11n14( double s )" );

}


// Tail(S, 11, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln11n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln11n15( double s )" );

}


// Tail(S, 11, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln11n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln11n30( double s )" );

}


// Tail(S, 11, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln11n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln11n100( double s )" );

}


// Tail(S, 12, 12)
double gkg::MannWhitneyWilcoxonUTest::utbln12n12( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln12n12( double s )" );

}


// Tail(S, 12, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln12n13( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln12n13( double s )" );

}


// Tail(S, 12, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln12n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln12n14( double s )" );

}


// Tail(S, 12, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln12n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln12n15( double s )" );

}


// Tail(S, 12, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln12n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln12n30( double s )" );

}


// Tail(S, 12, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln12n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln12n100( double s )" );

}


// Tail(S, 13, 13)
double gkg::MannWhitneyWilcoxonUTest::utbln13n13( double s )
{
  ...
  try
  {
    ...
    double tj1;
    double result = 0;
    x = std::min( 2 * ( s - 0.000000e+00 ) / 3.750000e+00-1, 1.0 );
    tj = 1;
    tj1 = x;
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln13n13( double s )" );

}


// Tail(S, 13, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln13n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln13n14( double s )" );

}


// Tail(S, 13, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln13n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln13n15( double s )" );

}


// Tail(S, 13, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln13n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln13n30( double s )" );

}


// Tail(S, 13, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln13n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln13n100( double s )" );

}


// Tail(S, 14, 14)
double gkg::MannWhitneyWilcoxonUTest::utbln14n14( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln14n14( double s )" );

}


// Tail(S, 14, 15)
double gkg::MannWhitneyWilcoxonUTest::utbln14n15( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln14n15( double s )" );

}


// Tail(S, 14, 30)
double gkg::MannWhitneyWilcoxonUTest::utbln14n30( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln14n30( double s )" );

}


// Tail(S, 14, 100)
double gkg::MannWhitneyWilcoxonUTest::utbln14n100( double s )
{
  ...
  GKG_CATCH( "double gkg::MannWhitneyWilcoxonUTest::utbln14n100( double s )" );

}


// forcing code instancitation for std::vector

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int8_t >(
                                      const std::vector< int8_t >& x,
                                      const std::vector< int8_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint8_t >(
                                      const std::vector< uint8_t >& x,
                                      const std::vector< uint8_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int16_t >(
                                      const std::vector< int16_t >& x,
                                      const std::vector< int16_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint16_t >(
                                      const std::vector< uint16_t >& x,
                                      const std::vector< uint16_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int32_t >(
                                      const std::vector< int32_t >& x,
                                      const std::vector< int32_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint32_t >(
                                      const std::vector< uint32_t >& x,
                                      const std::vector< uint32_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int64_t >(
                                      const std::vector< int64_t >& x,
                                      const std::vector< int64_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint64_t >(
                                      const std::vector< uint64_t >& x,
                                      const std::vector< uint64_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< float >(
                                      const std::vector< float >& x,
                                      const std::vector< float >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< double >(
                                      const std::vector< double >& x,
                                      const std::vector< double >& y ) const;


// forcing code instancitation for std::list

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int8_t >(
                                      const std::list< int8_t >& x,
                                      const std::list< int8_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint8_t >(
                                      const std::list< uint8_t >& x,
                                      const std::list< uint8_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int16_t >(
                                      const std::list< int16_t >& x,
                                      const std::list< int16_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint16_t >(
                                      const std::list< uint16_t >& x,
                                      const std::list< uint16_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int32_t >(
                                      const std::list< int32_t >& x,
                                      const std::list< int32_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint32_t >(
                                      const std::list< uint32_t >& x,
                                      const std::list< uint32_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< int64_t >(
                                      const std::list< int64_t >& x,
                                      const std::list< int64_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< uint64_t >(
                                      const std::list< uint64_t >& x,
                                      const std::list< uint64_t >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< float >(
                                      const std::list< float >& x,
                                      const std::list< float >& y ) const;

template 
gkg::MannWhitneyWilcoxonUTest::Result 
gkg::MannWhitneyWilcoxonUTest::test< double >(
                                      const std::list< double >& x,
                                      const std::list< double >& y ) const;
