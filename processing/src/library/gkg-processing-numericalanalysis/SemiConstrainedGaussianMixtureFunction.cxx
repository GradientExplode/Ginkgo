...
// Sum of gaussian with positivity constraint on a_i and \sigma_i coefficients


gkg::SemiConstrainedGaussianMixtureFunction::
                                         SemiConstrainedGaussianMixtureFunction( 
				                                    ...
				                                    parameters )
{
  ...
  GKG_CATCH( "gkg::SemiConstrainedGaussianMixtureFunction::"
             "SemiConstrainedGaussianMixtureFunction( "
             "const gkg::Vector& parameters )" );
...
double gkg::SemiConstrainedGaussianMixtureFunction::getValueWithParametersAt(
                                                    const gkg::Vector& x, 
		                                    const gkg::Vector& p ) const
{
  ...
  GKG_CATCH( "double gkg::SemiConstrainedGaussianMixtureFunction::"
...
gkg::Vector 
gkg::SemiConstrainedGaussianMixtureFunction::getDerivativeWithParametersAt(
                                                    const gkg::Vector& x, 
                                                    const gkg::Vector& p ) const
{
  ...
  GKG_CATCH( "gkg::Vector gkg::SemiConstrainedGaussianMixtureFunction::"
