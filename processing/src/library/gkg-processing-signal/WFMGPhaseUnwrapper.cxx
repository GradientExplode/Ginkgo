...
RegisterPhaseUnwrapper( gkg, WFMGPhaseUnwrapper, float );
RegisterPhaseUnwrapper( gkg, WFMGPhaseUnwrapper, double );
...
template < class T >
gkg::WFMGPhaseUnwrapper< T >::WFMGPhaseUnwrapper()
                             : gkg::PhaseUnwrapper< T >(),
                               _planeAxis( gkg::WFMGPhaseUnwrapper< T >::Z ),
                               _cycleCount( 2 ),
                               _coarsestSize( 3 ),
...
template < class T >
std::string gkg::WFMGPhaseUnwrapper< T >::getName() const
{
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::setPlaneAxis(
                    typename gkg::WFMGPhaseUnwrapper< T >::PlaneAxis planeAxis )
{
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::setPlaneAxis( "
             "gkg::WFMGPhaseUnwrapper< T >::PlaneAxis planeAxis ) const" );

}


template < class T >
void gkg::WFMGPhaseUnwrapper< T >::setCycleCount( int32_t count )
{
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::setCycleCount( int count )" );

}


template < class T >
void gkg::WFMGPhaseUnwrapper< T >::setCoarsestSize( int32_t size )
{
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::setCoarsestSize( int size )" );
...
template < class T >
void 
gkg::WFMGPhaseUnwrapper< T >::setPreSmoothingIterationCount( int32_t count )
{
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::"
             "setPreSmoothingIterationCount("
             " int count )" );
...
template < class T >
void 
gkg::WFMGPhaseUnwrapper< T >::setPostSmoothingIterationCount( int32_t count )
{
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::"
             "setPostSmoothingIterationCount("
             " int count )" );
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::useCongruence( bool value )
{
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::useCongruence( "
             "bool value ) const" );
...
template < class T >
typename gkg::WFMGPhaseUnwrapper< T >::PlaneAxis
gkg::WFMGPhaseUnwrapper< T >::getPlaneAxis() const
{
...
template < class T >
int32_t gkg::WFMGPhaseUnwrapper< T >::getCycleCount() const
{
...
template < class T >
int32_t gkg::WFMGPhaseUnwrapper< T >::getCoarsestSize() const
{
...
template < class T >
int32_t gkg::WFMGPhaseUnwrapper< T >::getPreSmoothingIterationCount() const
{
...
template < class T >
int32_t gkg::WFMGPhaseUnwrapper< T >::getPostSmoothingIterationCount() const
{
...
template < class T >
bool gkg::WFMGPhaseUnwrapper< T >::getUseCongruence() const
{
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::unwrap( gkg::Volume< T >& phase,
                                           ...
                                           bool verbose ) const
{
  ...
  try
  {
    ...
    if ( ( phase.getSizeX() != weights.getSizeX() ) ||
         ( phase.getSizeY() != weights.getSizeY() ) ||
         ( phase.getSizeZ() != weights.getSizeZ() ) ||
         ( phase.getSizeT() != weights.getSizeT() ) )
    {

      throw std::runtime_error( "incoherence between phase size(s) and weight "
                                "size(s)" );
    ...
    if ( _planeAxis == gkg::WFMGPhaseUnwrapper< T >::Z )
    {
      ...
      for ( slice = 0; slice < sliceCount; slice++ )
      {
        ...
        for ( line = 0; line < lineCount; line++ )
        {
          ...
          for ( x = 0; x < sizeX; x++ )
          {
            ...
            sliceWrappedPhase( x, line ) = ( phase( x, line, slice ) + M_PI ) /
                                           ( 2 * M_PI );
            sliceWeights( x, line ) = weights( x, line, slice );
        ...
        unwrapSlice( sliceUnwrappedPhase, sliceWeights );

        // making unwrapped phase slice congruent to wrapped phase slice
        if ( _useCongruence )
        {

          congruence( sliceWrappedPhase, sliceWeights, sliceUnwrappedPhase );
        ...
        for ( slice = 0; slice < sliceCount; slice++ )
        {
          ...
          for ( x = 0; x < sizeX; x++ )
          {
            ...
            sliceWrappedPhase( x, slice ) = ( phase( x, line, slice ) + M_PI ) /
                                           ( 2 * M_PI );
            sliceWeights( x, slice ) = weights( x, line, slice );
        ...
        for ( slice = 0; slice < sliceCount; slice++ )
        {
          ...
          for ( line = 0; line < lineCount; line++ )
          {
            ...
            sliceWrappedPhase( line, slice ) = ( phase( x, line, slice ) +
                                                 M_PI ) / ( 2 * M_PI );
            sliceWeights( line, slice ) = weights( x, line, slice );
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::unwrap( "
             "gkg::Volume< T >& phase, "
             "const gkg::Volume< T >& weights, "
             "bool verbose ) const" );
                                           ...
                                           bool verbose ) const
{
  ...
  try
  {
    ...
    gkg::Volume< T > weights( phase.getSizeX(),
                              phase.getSizeY(),
                              phase.getSizeZ() );
    weights.fill( 1.0 );
                              
    unwrap( phase, weights, verbose );
...
template < class T >
std::string gkg::WFMGPhaseUnwrapper< T >::getStaticName()
{

  return "weighted-full-multigrid-phase-unwrapper";

}


template < class T >
void gkg::WFMGPhaseUnwrapper< T >::unwrapSlice(
                                         gkg::Volume< T >& wrappedPhase,
                                         const gkg::Volume< T >& weights ) const
{
  ...
  try
  {
    ...
    WriteData2( "starting_weights", copyWeights );
...
template < class T >
T gkg::WFMGPhaseUnwrapper< T >::wrapPhase( const T& value ) const
{
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::fullMultigridVCycle(
                                    gkg::Volume< T >& fineUnwrappedPhase,
                                    const gkg::Volume< T >& fineGradientX,
                                    const gkg::Volume< T >& fineGradientY,
                                    const gkg::Volume< T >& fineWeightsX,
                                    const gkg::Volume< T >& fineWeightsY ) const
{
  ...
  try
  {
         ...
         ( coarseLineCount >= _coarsestSize ) )
    {
      ...
      gkg::Volume< T > coarseWeightsX( coarseSizeX, coarseLineCount );
      gkg::Volume< T > coarseWeightsY( coarseSizeX, coarseLineCount );
      gkg::Volume< T > coarseUnwrappedPhase( coarseSizeX, coarseLineCount );

      restrictWeights( fineWeightsX,
                       fineWeightsY,
                       coarseWeightsX,
                       coarseWeightsY );
      ...
      WriteData2( "restrict_weights-coarse_weights_x", coarseWeightsX );
      WriteData2( "restrict_weights-coarse_weights_y", coarseWeightsY );
  ...
  GKG_CATCH( "template < class T > "
             ...
             "const gkg::Volume< T >& weightsX, "
             "const gkg::Volume< T >& weightsY ) const" );

}


template < class T >
void gkg::WFMGPhaseUnwrapper< T >::vCycle(
                                    gkg::Volume< T >& fineUnwrappedPhase,
                                    const gkg::Volume< T >& fineGradientX,
                                    const gkg::Volume< T >& fineGradientY,
                                    const gkg::Volume< T >& fineWeightsX,
                                    const gkg::Volume< T >& fineWeightsY ) const
{
  ...
  try
  {
         ...
         ( coarseLineCount >= _coarsestSize ) )
    {
      ...
      WriteData2( "restrict_weights-coarse_weights_x",
                  coarseWeightsX );
      WriteData2( "restrict_weights-coarse_weights_y",
                  coarseWeightsY );
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::restrictWeights(
                                        const gkg::Volume< T >& fineWeightsX,
                                        const gkg::Volume< T >& fineWeightsY,
                                        gkg::Volume< T >& coarseWeightsX,
                                        gkg::Volume< T >& coarseWeightsY ) const
{

  try
  {

    int32_t fineSizeX = fineWeightsX.getSizeX();
    int32_t fineLineCount = fineWeightsX.getSizeY();
    int32_t coarseSizeX = coarseWeightsX.getSizeX();
    int32_t coarseLineCount = coarseWeightsX.getSizeY();
    int32_t x, line, xPrime, linePrime;
    int32_t x2, x3, x4, x5, x6, x7, x8, x9;
    int32_t line2, line3, line4, line5, line6, line7, line8, line9;
    ...
    for ( line = 0; line < coarseLineCount; line++ )
    {
      ...
      for ( x = 0; x < coarseSizeX; x++ )
      {
        ...
        if ( ( ( fineWeightsX( x5, line5 ) == 0.0 ) &&
               ( fineWeightsX( x9, line9 ) == 0.0 ) ) ||
             ( ( fineWeightsX( x6, line6 ) == 0.0 ) &&
               ( fineWeightsX( x8, line8 ) == 0.0 ) ) ||
             ( ( fineWeightsX( x6, line6 ) == 0.0 ) &&
               ( fineWeightsX( x9, line9 ) == 0.0 ) ) ||
             ( ( fineWeightsX( x5, line5 ) == 0.0 ) &&
               ( fineWeightsX( x8, line8 ) == 0.0 ) ) ||
             ( ( ( x == 0 ) || ( coarseWeightsX( x - 1, line ) != 0.0 ) ) &&
               ( ( ( fineWeightsX( x4, line4 ) == 0.0 ) &&
                   ( fineWeightsX( x8, line8 ) == 0.0 ) ) ||
                 ( ( fineWeightsX( x5, line5 ) == 0.0 ) &&
                   ( fineWeightsX( x7, line7 ) == 0.0 ) ) ) ) )
        {

          coarseWeightsX( x, line ) = 0.0;

        }
        else
        {

          coarseWeightsX( x, line ) = 0.25 * ( fineWeightsX( x5, line5 ) +
                                               fineWeightsX( x6, line6 ) +
                                               fineWeightsX( x8, line8 ) +
                                               fineWeightsX( x9, line9 ) );

        }

        if ( ( ( fineWeightsY( x5, line5 ) == 0.0 ) &&
               ( fineWeightsY( x9, line9 ) == 0.0 ) ) ||
             ( ( fineWeightsY( x6, line6 ) == 0.0 ) &&
               ( fineWeightsY( x8, line8 ) == 0.0 ) ) ||
             ( ( fineWeightsY( x8, line8 ) == 0.0 ) &&
               ( fineWeightsY( x9, line9 ) == 0.0 ) ) ||
             ( ( fineWeightsY( x5, line5 ) == 0.0 ) &&
               ( fineWeightsY( x6, line6 ) == 0.0 ) ) ||
             ( ( ( line == 0 ) || ( coarseWeightsY( x, line - 1 ) != 0.0 ) ) &&
               ( ( ( fineWeightsY( x2, line2 ) == 0.0 ) &&
                   ( fineWeightsY( x6, line6 ) == 0.0 ) ) ||
                 ( ( fineWeightsY( x3, line3 ) == 0.0 ) &&
                   ( fineWeightsY( x5, line5 ) == 0.0 ) ) ) ) )
        {

          coarseWeightsY( x, line ) = 0.0;

        }
        else
        {

          coarseWeightsY( x, line ) = 0.25 * ( fineWeightsY( x5, line5 ) +
                                               fineWeightsY( x6, line6 ) +
                                               fineWeightsY( x8, line8 ) +
                                               fineWeightsY( x9, line9 ) );
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::restrict(
                                     const gkg::Volume< T >& fineGradientX,
                                     const gkg::Volume< T >& fineGradientY,
                                     const gkg::Volume< T >& fineWeightsX,
                                     const gkg::Volume< T >& fineWeightsY,
                                     ...
                                     gkg::Volume< T >& coarseGradientY ) const
{
  ...
  try
  {
    ...
    T w1, w2, w3, w4, w5, w6, w7, w8, w9, wFactor;
    ...
    for ( line = 0; line < coarseLineCount; line++ )
    {
      ...
      for ( x = 0; x < coarseSizeX - 1; x++ )
      {
        ...
        w1 = ( ( fineWeightsX( x2, line2 ) > fineWeightsX( x1, line1 ) ) ?
               fineWeightsX( x1, line1 ) : fineWeightsX( x2, line2 ) );
        w2 = ( ( fineWeightsX( x3, line3 ) > fineWeightsX( x2, line2 ) ) ?
               fineWeightsX( x2, line2 ) : fineWeightsX( x3, line3 ) );
        w3 = ( ( fineWeightsX( x3 + 1, line3 ) > fineWeightsX( x3, line3 ) ) ?
               fineWeightsX( x3, line3 ) : fineWeightsX( x3 + 1, line3 ) );
        w4 = ( ( fineWeightsX( x5, line5 ) > fineWeightsX( x4, line4 ) ) ?
               fineWeightsX( x4, line4 ) : fineWeightsX( x5, line5 ) );
        w5 = ( ( fineWeightsX( x6, line6 ) > fineWeightsX( x5, line5 ) ) ?
               fineWeightsX( x5, line5 ) : fineWeightsX( x6, line6 ) );
        w6 = ( ( fineWeightsX( x6 + 1, line6 ) > fineWeightsX( x6, line6 ) ) ?
               fineWeightsX( x6, line6 ) : fineWeightsX( x6 + 1, line6 ) );
        w7 = ( ( fineWeightsX( x8, line8 ) > fineWeightsX( x7, line7 ) ) ?
               fineWeightsX( x7, line7 ) : fineWeightsX( x8, line8 ) );
        w8 = ( ( fineWeightsX( x9, line9 ) > fineWeightsX( x8, line8 ) ) ?
               fineWeightsX( x8, line8 ) : fineWeightsX( x9, line9 ) );
        w9 = ( ( fineWeightsX( x9 + 1, line9 ) > fineWeightsX( x9, line9 ) ) ?
               fineWeightsX( x9, line9 ) : fineWeightsX( x9 + 1, line9 ) );
        wFactor = 0.25 * w5 +
                  0.125 * ( w2 + w4 + w6 + w8 ) +
                  0.0625 * ( w1 + w3 + w7 + w9 ); 

        g1 = w1 * ( fineGradientX( x1, line1 ) -
                    ( fineUnwrappedPhase( x2, line2 ) -
                      fineUnwrappedPhase( x1, line1 ) ) );
        g2 = w2 * ( fineGradientX( x2, line2 ) -
                    ( fineUnwrappedPhase( x3, line3 ) -
                      fineUnwrappedPhase( x2, line2 ) ) );
        g3 = w3 * ( fineGradientX( x3, line3 ) -
                    ( fineUnwrappedPhase( x3 + 1, line3 ) -
                      fineUnwrappedPhase( x3, line3 ) ) );
        g4 = w4 * ( fineGradientX( x4, line4 ) -
                    ( fineUnwrappedPhase( x5, line5 ) -
                      fineUnwrappedPhase( x4, line4 ) ) );
        g5 = w5 * ( fineGradientX( x5, line5 ) -
                    ( fineUnwrappedPhase( x6, line6 ) -
                      fineUnwrappedPhase( x5, line5 ) ) );
        g6 = w6 * ( fineGradientX( x6, line6 ) -
                    ( fineUnwrappedPhase( x6 + 1, line6 ) -
                      fineUnwrappedPhase( x6, line6 ) ) );
        g7 = w7 * ( fineGradientX( x7, line7 ) -
                    ( fineUnwrappedPhase( x8, line8 ) -
                      fineUnwrappedPhase( x7, line7 ) ) );
        g8 = w8 * ( fineGradientX( x8, line8 ) -
                    ( fineUnwrappedPhase( x9, line9 ) -
                      fineUnwrappedPhase( x8, line8 ) ) );
        g9 = w9 * ( fineGradientX( x9, line9 ) -
                    ( fineUnwrappedPhase( x9 + 1, line9 ) -
                      fineUnwrappedPhase( x9, line9 ) ) );
        ...
        if ( wFactor > 1e-6 )
        {
          ...
          coarseGradientX( x, line ) = 0.25 * g5 +
                                       0.125 * ( g2 + g4 + g6 + g8 ) +
                                       0.0625 * ( g1 + g3 + g7 + g9 );
          coarseGradientX( x, line ) *= scale / wFactor;
        ...
        else
        {
          ...
          coarseGradientX( x, line ) = scale *
                                       fineGradientX( xPrime, linePrime );
    ...
    for ( line = 0; line < coarseLineCount - 1; line++ )
    {
      ...
      for ( x = 0; x < coarseSizeX; x++ )
      {
        ...
        w1 = ( ( fineWeightsY( x4, line4 ) > fineWeightsY( x1, line1 ) ) ?
               fineWeightsY( x1, line1 ) : fineWeightsY( x4, line4 ) );
        w2 = ( ( fineWeightsY( x5, line5 ) > fineWeightsY( x2, line2 ) ) ?
               fineWeightsY( x2, line2 ) : fineWeightsY( x5, line5 ) );
        w3 = ( ( fineWeightsY( x6, line6 ) > fineWeightsY( x3, line3 ) ) ?
               fineWeightsY( x3, line3 ) : fineWeightsY( x6, line6 ) );
        w4 = ( ( fineWeightsY( x7, line7 ) > fineWeightsY( x4, line4 ) ) ?
               fineWeightsY( x4, line4 ) : fineWeightsY( x7, line7 ) );
        w5 = ( ( fineWeightsY( x8, line8 ) > fineWeightsY( x5, line5 ) ) ?
               fineWeightsY( x5, line5 ) : fineWeightsY( x8, line8 ) );
        w6 = ( ( fineWeightsY( x9, line9 ) > fineWeightsY( x6, line6 ) ) ?
               fineWeightsY( x6, line6 ) : fineWeightsY( x9, line9 ) );
        w7 = ( ( fineWeightsY( x7, line7 + 1 ) > fineWeightsY( x7, line7 ) ) ?
               fineWeightsY( x7, line7 ) : fineWeightsY( x7, line7 + 1 ) );
        w8 = ( ( fineWeightsY( x8, line8 + 1 ) > fineWeightsY( x8, line8 ) ) ?
               fineWeightsY( x8, line8 ) : fineWeightsY( x8, line8 + 1 ) );
        w9 = ( ( fineWeightsY( x9, line9 + 1 ) > fineWeightsY( x9, line9 ) ) ?
               fineWeightsY( x9, line9 ) : fineWeightsY( x9, line9 + 1 ) );
        wFactor = 0.25 * w5 +
                  0.125 * ( w2 + w4 + w6 + w8 ) +
                  0.0625 * ( w1 + w3 + w7 + w9 ); 

        g1 = w1 * ( fineGradientY( x1, line1 ) -
                    ( fineUnwrappedPhase( x4, line4 ) -
                      fineUnwrappedPhase( x1, line1 ) ) );
        g2 = w2 * ( fineGradientY( x2, line2 ) -
                    ( fineUnwrappedPhase( x5, line5 ) -
                      fineUnwrappedPhase( x2, line2 ) ) );
        g3 = w3 * ( fineGradientY( x3, line3 ) -
                    ( fineUnwrappedPhase( x6, line6 ) -
                      fineUnwrappedPhase( x3, line3 ) ) );
        g4 = w4 * ( fineGradientY( x4, line4 ) -
                    ( fineUnwrappedPhase( x7, line7 ) -
                      fineUnwrappedPhase( x4, line4 ) ) );
        g5 = w5 * ( fineGradientY( x5, line5 ) -
                    ( fineUnwrappedPhase( x8, line8 ) -
                      fineUnwrappedPhase( x5, line5 ) ) );
        g6 = w6 * ( fineGradientY( x6, line6 ) -
                    ( fineUnwrappedPhase( x9, line9 ) -
                      fineUnwrappedPhase( x6, line6 ) ) );
        g7 = w7 * ( fineGradientY( x7, line7 ) -
                    ( fineUnwrappedPhase( x7, line7 + 1 ) -
                      fineUnwrappedPhase( x7, line7 ) ) );
        g8 = w8 * ( fineGradientY( x8, line8 ) -
                    ( fineUnwrappedPhase( x8, line8 + 1 ) -
                      fineUnwrappedPhase( x8, line8 ) ) );
        g9 = w9 * ( fineGradientY( x9, line9 ) -
                    ( fineUnwrappedPhase( x9, line9 + 1 ) -
                      fineUnwrappedPhase( x9, line9 ) ) );
        ...
        if ( wFactor > 1e-6 )
        {
          ...
          coarseGradientY( x, line ) = 0.25 * g5 +
                                       0.125 * ( g2 + g4 + g6 + g8 ) +
                                       0.0625 * ( g1 + g3 + g7 + g9 );
          coarseGradientY( x, line ) *= scale / wFactor;
        ...
        else
        {
          ...
          coarseGradientY( x, line ) = scale *
                                       fineGradientY( xPrime, linePrime );
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::prolongate(
                                   const gkg::Volume< T >& coarseUnwrappedPhase,
                                   const gkg::Volume< T >& coarseWeightsX,
                                   const gkg::Volume< T >& coarseWeightsY,
  ...
  try
  {
    ...
    for ( line = 0; line < coarseLineCount; line++ )
    {
      ...
      for ( x = 0; x < coarseSizeX; x++ )
      {
        ...
        w1 = std::min( coarseWeightsX( x1, line1 ),
                       coarseWeightsY( x1, line1 ) );
        w2 = std::min( coarseWeightsX( x2, line2 ),
                       coarseWeightsY( x2, line2 ) );
        w3 = std::min( coarseWeightsX( x3, line3 ),
                       coarseWeightsY( x3, line3 ) );
        w4 = std::min( coarseWeightsX( x4, line4 ),
                       coarseWeightsY( x4, line4 ) );
        ...
        if ( w > 0.0 )
        {
          ...
          p2 = ( w1 * coarseUnwrappedPhase( x1, line1 ) +
                 w2 * coarseUnwrappedPhase( x2, line2 ) ) / w;
        ...
        if ( w > 0.0 )
        {
          ...
          p3 = ( w1 * coarseUnwrappedPhase( x1, line1 ) +
                 w3 * coarseUnwrappedPhase( x3, line3 ) ) / w;
        ...
        if ( w > 0.0 )
        {
          ...
          p4 = ( w1 * coarseUnwrappedPhase( x1, line1 ) +
                 w2 * coarseUnwrappedPhase( x2, line2 ) +
                 w3 * coarseUnwrappedPhase( x3, line3 ) +
                 w4 * coarseUnwrappedPhase( x4, line4 ) ) / w;
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::relax( const gkg::Volume< T >& gradientX,
                                          const gkg::Volume< T >& gradientY,
                                          const gkg::Volume< T >& weightsX,
                                          const gkg::Volume< T >& weightsY,
                                          gkg::Volume< T >& unwrappedPhase,
                                          int32_t iterationCount ) const
{
      ...
      for ( pass = 0; pass < 2; pass++ )
      {
        ...
        for ( line = 0; line < lineCount; line++ )
        {
          ...
          for ( x = start; x < sizeX; x += 2 )
          {
            ...
            w1 = ( weightsX( x1, line1 ) > weightsX( x, line ) ?
                   weightsX( x, line ) : weightsX( x1, line1 ) );
            w1 *= w1;

            w2 = ( weightsX( x2, line2 ) > weightsX( x, line ) ?
                   weightsX( x, line ) : weightsX( x2, line2 ) );
            w2 *= w2;

            w3 = ( weightsY( x3, line3 ) > weightsY( x, line ) ?
                   weightsY( x, line ) : weightsY( x3, line3 ) );
            w3 *= w3;

            w4 = ( weightsY( x4, line4 ) > weightsY( x, line ) ?
                   weightsY( x, line ) : weightsY( x4, line4 ) );
            w4 *= w4;
            wFactor = w1 + w2 + w3 + w4;
            ...
            if ( wFactor > 1e-6 )
            {
              ...
              rho = ( w2 * gradientX( x, line ) - w1 * gx ) +
                    ( w4 * gradientY( x, line ) - w3 * gy );

              unwrappedPhase( x, line ) = ( w1 * unwrappedPhase( x1, line1 ) +
                                            w2 * unwrappedPhase( x2, line2 ) +
                                            w3 * unwrappedPhase( x3, line3 ) +
                                            w4 * unwrappedPhase( x4, line4 ) -
                                            rho ) / wFactor;
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::WFMGPhaseUnwrapper< T >::relax( "
             "const gkg::Volume< T >& gradientX, "
             "const gkg::Volume< T >& gradientY, "
             "const gkg::Volume< T >& weightsX, "
             "const gkg::Volume< T >& weightsY, "
...
template < class T >
void gkg::WFMGPhaseUnwrapper< T >::congruence(
                                   const gkg::Volume< T >& sliceWrappedPhase,
                                   const gkg::Volume< T >& sliceWeights,
...
template class gkg::WFMGPhaseUnwrapper< float >;
template class gkg::WFMGPhaseUnwrapper< double >;
