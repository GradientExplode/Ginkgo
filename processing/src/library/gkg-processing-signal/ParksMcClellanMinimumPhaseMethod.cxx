...
gkg::ParksMcClellanMinimumPhaseMethod::ParksMcClellanMinimumPhaseMethod()
...
gkg::ParksMcClellanMinimumPhaseMethod::getImpulseResponse(
                                                   int32_t sampleCount,
                                                   ...
                                                   double stopBandRipple ) const
{
  ...
  getMinPhaseFromMaxPhaseResponse( impulseResponse );
...
double gkg::ParksMcClellanMinimumPhaseMethod::getDInfinity(
                                                   double passBandRipple,
                                                   double stopBandRipple ) const
{
...
void gkg::ParksMcClellanMinimumPhaseMethod::getMaxPhaseFromLinPhaseResponse( 
      std::vector< std::complex< double > >& impulseResponse,
...
void gkg::ParksMcClellanMinimumPhaseMethod::getMinPhaseFromMaxPhaseResponse( 
                  std::vector< std::complex< double > >& impulseResponse ) const
{

  // we just have to reverse the maximum phase filter to get a minimum phase
  // filter
  std::reverse( impulseResponse.begin(), impulseResponse.end() );
