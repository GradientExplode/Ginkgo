#ifndef _gkg_processing_extrapolation_PolynomExtrapolator3d_i_h_
#define _gkg_processing_extrapolation_PolynomExtrapolator3d_i_h_


#include <gkg-processing-extrapolation/PolynomExtrapolator3d.h>
...
inline
gkg::PolynomExtrapolator3d< IN, MASK, OUT >::PolynomExtrapolator3d( 
                                                                int32_t degree )
...
template < class IN, class MASK, class OUT >
inline
void gkg::PolynomExtrapolator3d< IN, MASK, OUT >::extrapolate(
                                  ...
                                  bool verbose ) const
{
  ...
  try
  {
    ...
    int32_t count = ( _degree + 1 ) * ( _degree + 1 ) * ( _degree + 1 );
    ...
    float middleX = ( sizeX - 1 ) * 0.5;
    float middleY = ( sizeY - 1 ) * 0.5;
    float middleZ = ( sizeZ - 1 ) * 0.5;

    std::vector< gkg::Volume< float > > basisX( _degree + 1 );
    std::vector< gkg::Volume< float > > basisY( _degree + 1 );
    std::vector< gkg::Volume< float > > basisZ( _degree + 1 );
            ...
            for ( x = 0; x < sizeX; x++ )
            {
              ...
              switch ( o )
              {
                ...
                case 1:
                  ...
                  temp( x, y, z ) = std::pow( ( double )( x - middleX ),
                                              ( double )d ) /
                                    std::pow( 16.0, ( double )d );
                  break;

                case 2:

                  temp( x, y, z ) = std::pow( ( double )( y - middleY ),
                                              ( double )d ) /
                                    std::pow( 16.0, ( double )d );
                  break;
                ...
                case 3:
                  ...
                  temp( x, y, z ) = std::pow( ( double )( z - middleZ ),
                                              ( double )d ) /
                                    std::pow( 16.0, ( double )d );
                  break;
