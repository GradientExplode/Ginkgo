#ifndef _gkg_processing_process_SubVolumeEraserProcess_h_
#define _gkg_processing_process_SubVolumeEraserProcess_h_
...
class SubVolumeEraserProcess : public gkg::Process
{

  public:

    SubVolumeEraserProcess( const std::string& fileNameOut,
  ...
  private:
    ...
    template < class T >
    static void erase( gkg::Process& process,
