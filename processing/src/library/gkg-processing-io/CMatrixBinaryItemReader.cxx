...
gkg::CMatrixBinaryItemReader::CMatrixBinaryItemReader()
...
void gkg::CMatrixBinaryItemReader::read( std::istream& is,
                                         gkg::CMatrix* pItem,
                                         size_t count ) const
{
...
void gkg::CMatrixBinaryItemReader::read( gkg::largefile_ifstream& is,
                                         gkg::CMatrix* pItem,
                                         size_t count ) const
{
...
void gkg::CMatrixBinaryItemReader::read( gkg::largefile_fstream& fs,
                                         gkg::CMatrix* pItem,
                                         size_t count ) const
{
