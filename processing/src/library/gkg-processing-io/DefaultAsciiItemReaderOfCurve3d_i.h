#ifndef _gkg_processing_io_DefaultAsciiItemReaderOfCurve3d_i_h_
#define _gkg_processing_io_DefaultAsciiItemReaderOfCurve3d_i_h_
...
//
// class DefaultAsciiItemReader< Curve3d< float > >
//
...
template <>
inline
DefaultAsciiItemReader< Curve3d< float > >::DefaultAsciiItemReader()
...
template <>
inline
void DefaultAsciiItemReader< Curve3d< float > >::read( std::istream & is,
                                                       Curve3d< float >* pItem,
                                                       size_t count ) const
{
...
template <>
inline
void DefaultAsciiItemReader< Curve3d< float > >::read( largefile_ifstream & is,
                                                       Curve3d< float >* pItem,
                                                       size_t count ) const
{
...
template <>
inline
void DefaultAsciiItemReader< Curve3d< float > >::read( largefile_fstream & fs,
                                                       Curve3d< float >* pItem,
                                                       size_t count ) const
{
...
//
// class DefaultAsciiItemReader< Curve3d< double > >
//
...
template <>
inline
DefaultAsciiItemReader< Curve3d< double > >::DefaultAsciiItemReader()
...
template <>
inline
void DefaultAsciiItemReader< Curve3d< double > >::read(
                                                       std::istream & is,
