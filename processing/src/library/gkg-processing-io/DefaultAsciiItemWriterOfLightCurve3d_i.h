#ifndef _gkg_processing_io_DefaultAsciiItemWriterOfLightCurve3d_i_h_
#define _gkg_processing_io_DefaultAsciiItemWriterOfLightCurve3d_i_h_
...
//
// class DefaultAsciiItemWriter< LightCurve3d< float > >
//
...
template <>
inline
DefaultAsciiItemWriter< LightCurve3d< float > >::DefaultAsciiItemWriter()
                                                : ItemWriter<
                                                       LightCurve3d< float > >()
{
}
...
template <>
inline
void DefaultAsciiItemWriter< LightCurve3d< float > >::write(
                                             std::ostream & os,
...
//
// class DefaultAsciiItemWriter< LightCurve3d< double > >
//
...
template <>
inline
DefaultAsciiItemWriter< LightCurve3d< double > >::DefaultAsciiItemWriter()
                                                 : ItemWriter<
                                                      LightCurve3d< double > >()
{
}
...
template <>
inline
void DefaultAsciiItemWriter< LightCurve3d< double > >::write(
                                            std::ostream & os,
