...
gkg::MatrixBSwapItemReader::MatrixBSwapItemReader()
...
void gkg::MatrixBSwapItemReader::read( std::istream& is,
                                       gkg::Matrix* pItem,
                                       size_t count ) const
{
...
void gkg::MatrixBSwapItemReader::read( gkg::largefile_ifstream& is,
                                       gkg::Matrix* pItem,
                                       size_t count ) const
{
...
void gkg::MatrixBSwapItemReader::read( gkg::largefile_fstream& fs,
                                       gkg::Matrix* pItem,
                                       size_t count ) const
{
