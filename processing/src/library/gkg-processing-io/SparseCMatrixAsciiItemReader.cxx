...
gkg::SparseCMatrixAsciiItemReader::SparseCMatrixAsciiItemReader()
...
void gkg::SparseCMatrixAsciiItemReader::read( std::istream& is,
                                              ...
                                              size_t count ) const
{
  ...
  gkg::ItemReader< std::complex< double > >& itemR2 =
    gkg::DefaultItemIOFactory<
               std::complex< double > >::getInstance().getReader( true,
                                                                  false );
...
void gkg::SparseCMatrixAsciiItemReader::read( gkg::largefile_ifstream& is,
                                              gkg::SparseCMatrix* pItem,
                                              size_t count ) const
{
...
void gkg::SparseCMatrixAsciiItemReader::read( gkg::largefile_fstream& fs,
                                              gkg::SparseCMatrix* pItem,
                                              size_t count ) const
{
