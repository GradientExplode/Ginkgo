                                       ...
                                       OUT& out ) const
{
  ...
  GKG_CATCH( "template < class IN, class OUT > "
             "inline "
             "void gkg::StdDevFilter< IN, OUT >::filter( "
...
template < class IN, class OUT >
inline
void gkg::StdDevFilter< std::vector< IN >,
                                       ...
                                       OUT& out ) const
{
  ...
  try
  {
    ...
    gkg::Converter< double, OUT > converter;
    converter.convert( std::sqrt( sum ), out );
...
template < class OUT >
inline
void gkg::StdDevFilter< gkg::Vector,
...
template < class IN, class OUT >
inline
void gkg::StdDevFilter< gkg::Volume< IN >,
...
template < class OUT >
inline
void gkg::StdDevFilter< gkg::Matrix,
                                       ...
                                       OUT& out ) const
{
  ...
  GKG_CATCH( "template < class OUT > "
             "inline "
             "void gkg::StdDevFilter< gkg::Matrix, OUT >::filter( "
...
template < class OUT >
inline
void gkg::StdDevFilter< gkg::SparseMatrix,
                                       ...
                                       OUT& out ) const
{
  ...
  GKG_CATCH( "template < class OUT > "
             "inline "
             "void gkg::StdDevFilter< gkg::SparseMatrix, OUT >::filter( "
