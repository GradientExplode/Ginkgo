#ifndef _gkg_processing_registration_CorrelationCoefficientSimilarityMeasure_h_
#define _gkg_processing_registration_CorrelationCoefficientSimilarityMeasure_h_
...
class CorrelationCoefficientSimilarityMeasure : 
                                              public SimilarityMeasure< T1, T2 >
{
  ...
  public:
    ...
    CorrelationCoefficientSimilarityMeasure(
                     ...
                     bool verbose );
    virtual ~CorrelationCoefficientSimilarityMeasure();
