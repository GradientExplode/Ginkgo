#include <gkg-mri-reconstruction-plugin-functors/BrukerRaw2GisConverter/BrukerRaw2GisConverterCommand.h>
...
//
// class BrukerRawReadProcess
//

class BrukerRawReadProcess : public gkg::Process
{

  public:

    BrukerRawReadProcess( const std::string& fileNameOut,
...
BrukerRawReadProcess::BrukerRawReadProcess( const std::string& fileNameOut,
                          const std::string& outputFormat,
                          const std::string& fileNameMag,
                          const std::string& fileNamePha,
                          bool verbose )
              ...
              _verbose( verbose )
{
  ...
  registerProcess( "Volume", gkg::TypeOf< std::complex< float > >::getName(),
                   &BrukerRawReadProcess::read< std::complex< float > > );
  registerProcess( "Volume", gkg::TypeOf< std::complex< double > >::getName(),
                   &BrukerRawReadProcess::read< std::complex< double > > );

}


const std::string& BrukerRawReadProcess::getFileNameOut() const
{
...
const std::string& BrukerRawReadProcess::getOutputFormat() const
{
...
const std::string& BrukerRawReadProcess::getFileNameMag() const
{
...
const std::string& BrukerRawReadProcess::getFileNamePha() const
{
...
bool BrukerRawReadProcess::getVerbose() const
{
...
template < class T >
void BrukerRawReadProcess::read( gkg::Process& process,
                        const std::string& fileNameIn,
                        const gkg::AnalyzedObject&,
                        const std::string& )
{
  ...
  try
  {
    ...
    BrukerRawReadProcess&
      readProcess = static_cast< BrukerRawReadProcess& >( process );
...
gkg::BrukerRaw2GisConverterCommand::BrukerRaw2GisConverterCommand(
                                                              int32_t argc,
                                                              char* argv[],
                                                              bool loadPlugin,
                                                              bool removeFirst )
                                                   ...
                                                   removeFirst )
{
  ...
  GKG_CATCH( "gkg::BrukerRaw2GisConverterCommand::"
             "BrukerRaw2GisConverterCommand( "
...
std::string gkg::BrukerRaw2GisConverterCommand::getStaticName()
{

  try
  {

    return "BrukerRaw2GisConverter";

  }
  GKG_CATCH( "std::string gkg::BrukerRaw2GisConverterCommand::getStaticName()" );

}


void gkg::BrukerRaw2GisConverterCommand::parse()
{
  ...
  try
  {
    ...
    gkg::Application application( _argc, _argv,
                                  "Bruker Raw to GIS disk format converter",
                                  _loadPlugin );
  ...
  GKG_CATCH_FUNCTOR( "void gkg::BrukerRaw2GisConverterCommand::parse()" );

}


void gkg::BrukerRaw2GisConverterCommand::execute(
                                                const std::string& fileNameIn,
                                                const std::string& fileNameOut,
                                                const std::string& outputFormat,
                                                const std::string& fileNameMag,
                                                ...
                                                bool verbose )
{
  ...
  try
  {
    ...
    BrukerRawReadProcess brukerRawReadProcess( fileNameOut, outputFormat,
                                               fileNameMag, fileNamePha,
                                               verbose );
    brukerRawReadProcess.execute( fileNameIn );

  }
  GKG_CATCH( "void gkg::BrukerRaw2GisConverterCommand::execute( "
             "const std::string& fileNameIn, "
             "const std::string& fileNameOut, "
             "const std::string& outputFormat, "
             "const std::string& fileNameMag, "
