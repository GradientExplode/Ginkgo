#include <gkg-mri-reconstruction-plugin-functors/GehcEpiDwReconstructor/GehcEpiDwReconstructorCommand.h>
...
gkg::GehcEpiDwReconstructorCommand::GehcEpiDwReconstructorCommand(
                                                              int32_t argc,
                                                              char* argv[],
                                                              bool loadPlugin,
                                                              bool removeFirst )
                                                   ...
                                                   removeFirst )
{
  ...
  GKG_CATCH( "gkg::GehcEpiDwReconstructorCommand::"
...
std::string gkg::GehcEpiDwReconstructorCommand::getStaticName()
{

  try
  {

    return "GehcEpiDwReconstructor";

  }
  GKG_CATCH( "std::string gkg::GehcEpiDwReconstructorCommand::getStaticName()" );

}


void gkg::GehcEpiDwReconstructorCommand::parse()
{
  ...
  GKG_CATCH_FUNCTOR( "void gkg::GehcEpiDwReconstructorCommand::parse()" );

}


void gkg::GehcEpiDwReconstructorCommand::execute(
                                            const std::string& fileNameIn,
                                            const std::string& fileNameOut,
                                            const std::string& xApodizationName,
                                            const std::string& yApodizationName,
...
*/
  ...
  GKG_CATCH( "void gkg::GehcEpiDwReconstructorCommand::execute( "
             "const std::string& fileNameIn, "
             "const std::string& fileNameOut, "
             "const std::string& xApodizationName, "
             "const std::string& yApodizationName, "
