#include <gkg-mri-reconstruction-plugin-functors/IsmrmrdRaw2GisConverter/IsmrmrdRaw2GisConverterCommand.h>
...
//
// class IsmrmrdRawReadProcess
//

class IsmrmrdRawReadProcess : public gkg::Process
{

  public:

    IsmrmrdRawReadProcess( const std::string& fileNameOut,
...
IsmrmrdRawReadProcess::IsmrmrdRawReadProcess( const std::string& fileNameOut,
                                              const std::string& outputFormat,
                                              const std::string& fileNameMag,
                                              const std::string& fileNamePha,
                                              bool verbose )
                        ...
                        _verbose( verbose )
{
  ...
  registerProcess( "Volume", gkg::TypeOf< std::complex< float > >::getName(),
                   &IsmrmrdRawReadProcess::read< std::complex< float > > );
  registerProcess( "Volume", gkg::TypeOf< std::complex< double > >::getName(),
                   &IsmrmrdRawReadProcess::read< std::complex< double > > );

}


const std::string& IsmrmrdRawReadProcess::getFileNameOut() const
{
...
const std::string& IsmrmrdRawReadProcess::getOutputFormat() const
{
...
const std::string& IsmrmrdRawReadProcess::getFileNameMag() const
{
...
const std::string& IsmrmrdRawReadProcess::getFileNamePha() const
{
...
bool IsmrmrdRawReadProcess::getVerbose() const
{
...
template < class T >
void IsmrmrdRawReadProcess::read( gkg::Process& process,
                                  const std::string& fileNameIn,
                                  const gkg::AnalyzedObject&,
                                  const std::string& )
{
  ...
  try
  {
    ...
    IsmrmrdRawReadProcess&
      readProcess = static_cast< IsmrmrdRawReadProcess& >( process );
    ...
    if ( readProcess.getVerbose() )
    {
      ...
      std::cout << "reading Ismrmrd Raw file header: "
                << fileNameIn << std::endl;
    ...
    format = gkg::Reader::getInstance().template preparePartialBinaryRead<
                                                           gkg::Volume< T > >(
                                                             fileNameIn,
                                                             inputVolumeProxy );
    if ( format != "ismrmrd-raw" )
    {

      throw std::runtime_error( "wrong format, should be \'ismrmrd-raw\'");
    ...
    for ( time = 0; time < timeCount; time++ )
    {
      ...
      // reading raw data from fid Ismrmrd file
...
gkg::IsmrmrdRaw2GisConverterCommand::IsmrmrdRaw2GisConverterCommand(
                                                              int32_t argc,
                                                              char* argv[],
                                                              bool loadPlugin,
                                                              bool removeFirst )
                                                    ...
                                                    removeFirst )
{
  ...
  GKG_CATCH( "gkg::IsmrmrdRaw2GisConverterCommand::"
             "IsmrmrdRaw2GisConverterCommand( "
...
std::string gkg::IsmrmrdRaw2GisConverterCommand::getStaticName()
{

  try
  {

    return "IsmrmrdRaw2GisConverter";

  }
  GKG_CATCH( "std::string gkg::IsmrmrdRaw2GisConverterCommand::getStaticName()" );

}


void gkg::IsmrmrdRaw2GisConverterCommand::parse()
{
  ...
  try
  {
    ...
    gkg::Application application( _argc, _argv,
                                  "Ismrmrd Raw to GIS disk format converter",
                                  _loadPlugin );
    application.addSingleOption( "-i",
                                 "Input Ismrmrd Raw directory name",
                                 fileNameIn );
  ...
  GKG_CATCH_FUNCTOR( "void gkg::IsmrmrdRaw2GisConverterCommand::parse()" );

}


void gkg::IsmrmrdRaw2GisConverterCommand::execute(
                                                const std::string& fileNameIn,
                                                const std::string& fileNameOut,
                                                const std::string& outputFormat,
                                                const std::string& fileNameMag,
                                                ...
                                                bool verbose )
{
  ...
  try
  {
    ...
    IsmrmrdRawReadProcess ismrmrdRawReadProcess( fileNameOut, outputFormat,
                                               fileNameMag, fileNamePha,
                                               verbose );
    ismrmrdRawReadProcess.execute( fileNameIn );

  }
  GKG_CATCH( "void gkg::IsmrmrdRaw2GisConverterCommand::execute( "
             "const std::string& fileNameIn, "
             "const std::string& fileNameOut, "
             "const std::string& outputFormat, "
             "const std::string& fileNameMag, "
