                      ...
                      _rfSpoilPhase( 0 )
{
  ...
  std::vector< double > trapezoidDiffusionDoubleParameters;
  std::vector< std::string > trapezoidDiffusionStringParameters;
  _sequenceModules[ "02-TrapezoidDiffusionGradientModule" ] = 
    gkg::SequenceModuleFactory::getInstance().create(
                                          "TrapezoidDiffusionGradientModule",
                                          trapezoidDiffusionDoubleParameters,
                                          trapezoidDiffusionStringParameters,
                                          _sequenceModules );                                        
  ...
  singleLineReading2dDoubleParameters[ 0 ] = 30000; // Default TE
  ...
  _sequenceModules[ "04-SingleLineReading2dModule" ] = 
    gkg::SequenceModuleFactory::getInstance().create(
  ...
  spoiling2dStringParameters[ 0 ] = "01-SingleTxExcitation2dModule"; 
                                                                   // Excitation
  spoiling2dStringParameters[ 1 ] = "04-SingleLineReading2dModule"; // Reading
  _sequenceModules[ "05-Spoiling2dModule" ] = 
    gkg::SequenceModuleFactory::getInstance().create(
                                          "Spoiling2dModule",
                                        ...
                                        MrProtocolData::SeqExpo& seqExpo )
{
  ...
  if( static_cast< const gkg::TrapezoidDiffusionGradientModule* >(
                _sequenceModules.find( "02-TrapezoidDiffusionGradientModule" )->
                second.getPointer() )->getSeparationTime() <
      _sequenceModules[ "03-RefocusingModule" ]-> getTotalDuration() )
  {
    
    UTRACE( Error, 0, 
      "+-+-+ Refocusing module longer than duration between diffusion gradients" 
      << "\n+-+-+ REFOC DUR : " << 
      _sequenceModules[ "03-RefocusingModule" ]-> getTotalDuration() <<
      "\n+-+-+ DIFF DIFFERENCE : " <<
      static_cast< const gkg::TrapezoidDiffusionGradientModule* >(
                _sequenceModules.find( "02-TrapezoidDiffusionGradientModule" )->
                second.getPointer() )->getSeparationTime() );
  ...
  int32_t minimumRequiredTR =
                      ...
                      _sequenceModules[ "05-Spoiling2dModule" ]->
                                                            getTotalDuration() +
                      _sequenceModules[ "06-EndModule" ]->getTotalDuration();
                                      ...
                                      MrProtocolData::SeqExpo& seqExpo )
{
  ...
  gkg::TrapezoidDiffusionGradientModule*
    trapezoidDiffusionGradientModule = 
       static_cast< gkg::TrapezoidDiffusionGradientModule* >(
       _sequenceModules[ "02-TrapezoidDiffusionGradientModule" ].getPointer() );
  gkg::SingleLineReading2dModule*
    singleLineReading2dModule = static_cast< gkg::SingleLineReading2dModule* >(
              _sequenceModules[ "04-SingleLineReading2dModule" ].getPointer() );
                                           ...
                                           long lineIndex )
{
  ...
  _sequenceModules[ "04-SingleLineReading2dModule" ]->setAnchorTime( 
         mrProt.te()[ 0 ] +
         _sequenceModules[ "01-SingleTxExcitation2dModule" ]->
                                                 getDurationBeforeAnchorTime());

  _sequenceModules[ "05-Spoiling2dModule" ]->setAnchorTime( 
         _sequenceModules[ "04-SingleLineReading2dModule" ]->getEndTime() );

   _sequenceModules[ "06-EndModule" ]->setAnchorTime( mrProt.tr()[ 0 ] );
   _sequenceModules[ "06-EndModule" ]->setAnchorTime( mrProt.tr()[ 0 ] );
   _sequenceModules[ "06-EndModule" ]->setAnchorTime( mrProt.tr()[ 0 ] );
