#ifndef _gkg_pulse_sequence_GinkgoLibrary_MultiLineEPIReading3dModule_h_
#define _gkg_pulse_sequence_GinkgoLibrary_MultiLineEPIReading3dModule_h_
...
class MultiLineEPIReading3dModule :
                  public ReadingModule,
                  public Creator3Arg< MultiLineEPIReading3dModule,
                                      SequenceModule,
                                                ...
                                                RCPointer< SequenceModule > >& >
{
  ...
  public:
    ...
    virtual ~MultiLineEPIReading3dModule();
  ...
  protected:
    ...
    friend struct Creator3Arg< MultiLineEPIReading3dModule,
                               SequenceModule,
                               const std::vector< double >&,
                               const std::vector< std::string >&,
                               const std::map<
