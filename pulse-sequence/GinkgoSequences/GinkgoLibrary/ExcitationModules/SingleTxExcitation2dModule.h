#ifndef _gkg_pulse_sequence_GinkgoLibrary_SingleTxExcitation2dModule_h_
#define _gkg_pulse_sequence_GinkgoLibrary_SingleTxExcitation2dModule_h_
...
class SingleTxExcitation2dModule : 
                         public ExcitationModule,
                         public Creator3Arg< SingleTxExcitation2dModule,
                                             SequenceModule,
                                                ...
                                                RCPointer< SequenceModule > >& >
{
  ...
  public:
    ...
    virtual ~SingleTxExcitation2dModule();
  ...
  protected:
    ...
    friend struct Creator3Arg< SingleTxExcitation2dModule,
                               SequenceModule,
                               const std::vector< double >&,
                               const std::vector< std::string >&,
                               const std::map<
    ...
    sGRAD_PULSE _sliceSelectionRefocus;
