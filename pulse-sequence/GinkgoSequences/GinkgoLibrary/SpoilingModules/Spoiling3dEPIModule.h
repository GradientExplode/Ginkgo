#ifndef _gkg_pulse_sequence_GinkgoSpinEcho3d_Spoiling3dEPIModule_h_
#define _gkg_pulse_sequence_GinkgoSpinEcho3d_Spoiling3dEPIModule_h_
...
class Spoiling3dEPIModule : public SpoilingModule,
                         public Creator3Arg< Spoiling3dEPIModule,
                                             SequenceModule,
                                                ...
                                                RCPointer< SequenceModule > >& >
{
  ...
  protected:
    ...
    friend struct Creator3Arg< Spoiling3dEPIModule,
                               SequenceModule,
                               const std::vector< double >&,
                               const std::vector< std::string >&,
                               const std::map<
