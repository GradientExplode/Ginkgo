...
gkg::Spoiling3dEVIModule::Spoiling3dEVIModule( 
...
void gkg::Spoiling3dEVIModule::initialize( SeqLim& seqLim )
{
...
NLSStatus gkg::Spoiling3dEVIModule::prepare( MrProt& mrProt,
                                          SeqLim& seqLim,
                                          MrProtocolData::SeqExpo& seqExpo )
{

  static const char *ptModule = { "gkg::Spoiling3dEVIModule::prepare" };
...
NLS_STATUS gkg::Spoiling3dEVIModule::modifyKernel(
                                              MrProt& mrProt,
                                              SeqLim& seqLim,
                                              MrProtocolData::SeqExpo& seqExpo,
...
NLS_STATUS gkg::Spoiling3dEVIModule::setKernelTiming( MrProt& mrProt )
{
...
long gkg::Spoiling3dEVIModule::getTotalPartitionRewindingDuration() const
{
...
long gkg::Spoiling3dEVIModule::getTimeAfterAdc() const
{
...
std::string gkg::Spoiling3dEVIModule::getStaticName()
{

  return "Spoiling3dEVIModule";

}

//
// adding the Spoiling3dEVIModule creator to the sequence module factory
//

RegisterSequenceModuleCreator( gkg, Spoiling3dEVIModule );
