#ifndef _gkg_qmri_plugin_functors_MyelinWaterFractionMapper_IRSEBasedMyelinWaterFractionMCMCFunction_h_
#define _gkg_qmri_plugin_functors_MyelinWaterFractionMapper_IRSEBasedMyelinWaterFractionMCMCFunction_h_
...
class IRSEBasedMyelinWaterFractionMCMCFunction :
                                          public MyelinWaterFractionMCMCFunction
{
  ...
  public:
    ...
    virtual ~IRSEBasedMyelinWaterFractionMCMCFunction();
