#include <gkg-dmri-plugin-functors/DwiRicianFitAbacus/DwiRicianFitAbacusCommand.h>
...
gkg::DwiRicianFitAbacusCommand::DwiRicianFitAbacusCommand( int32_t argc,
                                                           char* argv[],
                                                           bool loadPlugin,
                                                           bool removeFirst )
                                               ...
                                               removeFirst )
{
  ...
  GKG_CATCH( "gkg::DwiRicianFitAbacusCommand::DwiRicianFitAbacusCommand( "
...
gkg::DwiRicianFitAbacusCommand::DwiRicianFitAbacusCommand(
...
std::string gkg::DwiRicianFitAbacusCommand::getStaticName()
{

  try
  {

    return "DwiRicianFitAbacus";

  }
  GKG_CATCH( "std::string gkg::DwiRicianFitAbacusCommand::getStaticName()" );

}


void gkg::DwiRicianFitAbacusCommand::parse()
{
  ...
  try
  {
    ...
    gkg::Application application( _argc, 
				  _argv, 
                                  "Build an abacus of fits of Rician "
				  "distributions with a Gaussian mixture",
                                  _loadPlugin );
  ...
  GKG_CATCH_FUNCTOR( "void gkg::DwiRicianFitAbacusCommand::parse()" );

}


void gkg::DwiRicianFitAbacusCommand::execute(
                                            const std::string& outputName,
                                            const std::vector< double >& vs,
                                            const std::vector< double >& sigmas,
                                            int32_t gaussianCount,
                                            ...
                                            bool verbose )
{
  ...
  try
  {
	...
	riceParameters( 1 ) = sigma;
        ...
        double s = rice.getApproximateStandardDeviation();
    ...
    abacus.getHeader().addAttribute( "abacus", std::string( "rice" ) );
  ...
  GKG_CATCH( "void gkg::DwiRicianFitAbacusCommand::execute( "
             "const std::string& outputName, "
             "const std::vector< double >& vs, "
             "const std::vector< double >& sigmas, "
             "int32_t gaussianCount, "
