#include <gkg-dmri-pdf-functor/EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized.h>
...
gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::
...
std::string 
gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::getName() const
{

  return "msdgfa_scaled_eap_meshes";

}


bool 
gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::isStandardBasisRequired() 
const
{
...
void gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::process(
			   ...
			   bool verbose ) const
{
  ...
  GKG_CATCH( "void gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::process( "
...
void gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::processItem(
                 ...
                 const std::vector< std::string >& /*stringParameters*/ ) const
{
  ...
  GKG_CATCH( "void gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::processItem( "
             "std::vector< float >& item, "
             "const gkg::OrientationDistributionFunction& eap, "
             "const std::vector< double >& scalarParameters, "
             "const std::vector< std::string >& /*stringParameters*/ ) "
...
static bool register_gkg_EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized 
                                                       __attribute__((unused)) =
gkg::EapFunctorFactory< gkg::MeshMap< int32_t, float, 3U > ,
                        std::vector< float > >::getInstance().
                                                           registerEapFunctor(
          gkg::EapFunctorMSDGFAScaledEapMeshesMinMaxNormalized::getInstance() );
