#ifndef _gkg_dmri_pdf_functor_EapFunctorMSDGFAScaledEapMeshesMaxNormalized_h_
#define _gkg_dmri_pdf_functor_EapFunctorMSDGFAScaledEapMeshesMaxNormalized_h_
...
class EapFunctorMSDGFAScaledEapMeshesMaxNormalized :
                    public EapFunctor< MeshMap< int32_t, float, 3U >,
                                       std::vector< float > >,
                    public Singleton< EapFunctorMSDGFAScaledEapMeshesMaxNormalized >
{
  ...
  protected:
    ...
    friend class Singleton< EapFunctorMSDGFAScaledEapMeshesMaxNormalized >;
