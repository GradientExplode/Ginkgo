...
gkg::FiberSelectionChecker::FiberSelectionChecker()
{
}
...
std::string gkg::FiberSelectionChecker::getNameListHelp() const
{
  ...
  GKG_CATCH( "std::string "
             "gkg::FiberSelectionChecker::getNameListHelp() const" );

}


std::set< std::string > gkg::FiberSelectionChecker::getNames() const
{
  ...
  GKG_CATCH( "std::set< std::string > "
             "gkg::FiberSelectionChecker::getNames() const" );

}


const std::string& gkg::FiberSelectionChecker::getStringParameterHelp(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberSelectionChecker::getStringParameterHelp( "
             "const std::string& name ) const" );

}


const std::string& gkg::FiberSelectionChecker::getScalarParameterHelp(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberSelectionChecker::getScalarParameterHelp( "
             "const std::string& name ) const" );

}


int32_t gkg::FiberSelectionChecker::getStringParameterCount(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberSelectionChecker::getStringParameterCount( "
             "const std::string& name ) const" );

}


int32_t gkg::FiberSelectionChecker::getScalarParameterCount(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberSelectionChecker::getScalarParameterCount( "
             "const std::string& name ) const" );

}


void gkg::FiberSelectionChecker::doSanityChecks(
                           ...
                           const std::vector< double >& scalarParameters ) const
{
  ...
  try
  {
    ...
    std::map< std::string,
              gkg::FiberSelectionChecker::SanityCheckFunctor >::const_iterator
  ...
  GKG_CATCH( "void gkg::FiberSelectionChecker::doSanityChecks( "
             "const std::string& name, "
             "const std::vector< std::string >& stringParameters, "
             "const std::vector< double >& scalarParameters ) const" );
...
void gkg::FiberSelectionChecker::addChecker(
               const std::string& name,
               ...
               gkg::FiberSelectionChecker::SanityCheckFunctor sanityCheckFunctor )
{
  ...
  GKG_CATCH( "void gkg::FiberSelectionChecker::addChecker( "
             "const std::string& name, "
             "const std::string& stringParameterHelp, "
             "const std::string& scalarParameterHelp, "
             "int32_t stringParameterCount, "
             "int32_t scalarParameterCount, "
             "gkg::FiberSelectionChecker::SanityCheckFunctor "
             "sanityCheckFunctor )" );
