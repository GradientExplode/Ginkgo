                                                        ...
                                                        outputOrientationSet )
{
  ...
  try
  {
    ...
    _maximumSphericalHarmonicOrder = ( int32_t )(
                                          specificScalarParameters[ 0 ] + 0.5 );
    ...
    _items.getHeader().addAttribute(
                  "odf_type",
                  gkg::TypeOf< gkg::SolidAngleAnalyticalQBallOdf >::getName() );

    this->_functor = new gkg::SolidAngleAnalyticalQBallOdfCartesianFieldFunctor(
                                                                        *this );
  ...
  GKG_CATCH( "gkg::SolidAngleAnalyticalQBallOdfCartesianField::"
             "SolidAngleAnalyticalQBallOdfCartesianField( "
             "gkg::RCPointer< gkg::Volume< float > > t2, "
             "gkg::RCPointer< gkg::Volume< float > > dw, "
             "gkg::RCPointer< gkg::Volume< int16_t > > mask, "
...
int32_t 
gkg::SolidAngleAnalyticalQBallOdfCartesianField::
                                        getMaximumSphericalHarmonicOrder() const
{
...
int32_t 
gkg::SolidAngleAnalyticalQBallOdfCartesianField::
                                               getSphericalHarmonicCount() const
{
...
float 
gkg::SolidAngleAnalyticalQBallOdfCartesianField::
                                           getRegularizationLCurveFactor() const
{
...
float 
gkg::SolidAngleAnalyticalQBallOdfCartesianField::getLaplacianSharpening() const
{
...
const gkg::Matrix& 
gkg::SolidAngleAnalyticalQBallOdfCartesianField::getReconstructionMatrix() const
{
...
const gkg::Matrix& 
gkg::SolidAngleAnalyticalQBallOdfCartesianField::getBplus() const
{
...
void gkg::SolidAngleAnalyticalQBallOdfCartesianField::
                          ...
                          std::vector< std::string >& specificStringParameters )
{
  ...
  GKG_CATCH( "void gkg::SolidAngleAnalyticalQBallOdfCartesianField::"
             "checkOrInitializeDefaultParameters( "
             "std::vector< double >& specificScalarParameters, "
             "std::vector< std::string >& specificStringParameters )" );
...
void 
gkg::SolidAngleAnalyticalQBallOdfCartesianField::getReconstructionMatrix(
                                                                  bool verbose )
{
  ...
  try
  {
    ...
    if ( _laplacianSharpening > 0 )
    {
      ...
      _reconstructionMatrix = P.getComposition( Sharpening ).
                                   getComposition( L ).getComposition( _Bplus );
    ...
    else
    {
      ...
      // building reconstruction matrix PBplus
      _reconstructionMatrix = P.getComposition( L ).getComposition( _Bplus );
...
gkg::SolidAngleAnalyticalQBallOdfCartesianField::newItem(
                                     ...
                                     const gkg::Vector3d< int32_t >& lutSite )
{
  ...
  try
  {
    ...
    gkg::SolidAngleAnalyticalQBallOdf analyticalQBallOdf( 
