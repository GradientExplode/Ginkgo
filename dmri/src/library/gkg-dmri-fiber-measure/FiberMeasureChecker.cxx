...
gkg::FiberMeasureChecker::FiberMeasureChecker()
{
}
...
std::string gkg::FiberMeasureChecker::getNameListHelp() const
{
  ...
  GKG_CATCH( "std::string "
             "gkg::FiberMeasureChecker::getNameListHelp() const" );

}


std::set< std::string > gkg::FiberMeasureChecker::getNames() const
{
  ...
  GKG_CATCH( "std::set< std::string > "
             "gkg::FiberMeasureChecker::getNames() const" );

}


const std::string& gkg::FiberMeasureChecker::getStringParameterHelp(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberMeasureChecker::getStringParameterHelp( "
             "const std::string& name ) const" );

}


const std::string& gkg::FiberMeasureChecker::getScalarParameterHelp(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberMeasureChecker::getScalarParameterHelp( "
             "const std::string& name ) const" );

}


int32_t gkg::FiberMeasureChecker::getStringParameterCount(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberMeasureChecker::getStringParameterCount( "
             "const std::string& name ) const" );

}


int32_t gkg::FiberMeasureChecker::getScalarParameterCount(
                                                 const std::string& name ) const
{
  ...
  GKG_CATCH( "int32_t gkg::FiberMeasureChecker::getScalarParameterCount( "
             "const std::string& name ) const" );

}


void gkg::FiberMeasureChecker::doSanityChecks(
                           ...
                           const std::vector< double >& scalarParameters ) const
{
  ...
  try
  {
    ...
    std::map< std::string,
              gkg::FiberMeasureChecker::SanityCheckFunctor >::const_iterator
  ...
  GKG_CATCH( "void gkg::FiberMeasureChecker::doSanityChecks( "
             "const std::string& name, "
             "const std::vector< std::string >& stringParameters, "
             "const std::vector< double >& scalarParameters ) const" );
...
void gkg::FiberMeasureChecker::addChecker(
               const std::string& name,
               ...
               gkg::FiberMeasureChecker::SanityCheckFunctor sanityCheckFunctor )
{
  ...
  GKG_CATCH( "void gkg::FiberMeasureChecker::addChecker( "
             "const std::string& name, "
             "const std::string& stringParameterHelp, "
             "const std::string& scalarParameterHelp, "
             "int32_t stringParameterCount, "
             "int32_t scalarParameterCount, "
             "gkg::FiberMeasureChecker::SanityCheckFunctor "
             "sanityCheckFunctor )" );
