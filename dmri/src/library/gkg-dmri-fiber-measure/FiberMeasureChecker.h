#ifndef _gkg_dmri_fiber_measure_FiberMeasureChecker_h_
#define _gkg_dmri_fiber_measure_FiberMeasureChecker_h_
...
class FiberMeasureChecker : public Singleton< FiberMeasureChecker >
{
  ...
  protected:
    ...
    friend class Singleton< FiberMeasureChecker >;
