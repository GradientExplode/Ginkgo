...
gkg::SmsVb15MultipleSameShellQSpaceSampling::
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    this->_orientationSets[ 0 ] = gkg::SmsVb15OrientationSet(
                                                         orientationCount );
  ...
  GKG_CATCH( "gkg::SmsVb15MultipleSameShellQSpaceSampling::"
             "SmsVb15MultipleSameShellQSpaceSampling( "
             "const std::vector< float >& shellBValues, "
             "int32_t orientationCount, "
             "const gkg::HomogeneousTransform3d< float >& transform3d, "
...
void gkg::SmsVb15MultipleSameShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  try
  {
    ...
    headeredObject.getHeader().addAttribute(
      ...
      std::string( "spherical_multiple-shell_same-orientation-set_smsvb15" ) );
    headeredObject.getHeader().addAttribute(
      "diffusion_sensitization_parameters",
      diffusion_sensitization_parameters );

  }
  GKG_CATCH( "void gkg::SmsVb15MultipleSameShellQSpaceSampling::"
