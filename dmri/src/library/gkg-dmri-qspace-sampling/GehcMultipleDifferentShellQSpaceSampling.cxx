...
gkg::GehcMultipleDifferentShellQSpaceSampling::
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    for ( s = 0; s < shellCount; s++ )
    {
      ...
      this->_orientationSets[ s ] = gkg::GehcOrientationSet(
                                                      orientationCounts[ s ] );
  ...
  GKG_CATCH( "gkg::GehcMultipleDifferentShellQSpaceSampling::"
             "GehcMultipleDifferentShellQSpaceSampling( "
             "const std::vector< float >& shellBValues, "
             "const std::vector< int32_t >& orientationCounts, "
             "const gkg::HomogeneousTransform3d< float >& transform3d, "
...
void gkg::GehcMultipleDifferentShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  GKG_CATCH( "void gkg::GehcMultipleDifferentShellQSpaceSampling::"
