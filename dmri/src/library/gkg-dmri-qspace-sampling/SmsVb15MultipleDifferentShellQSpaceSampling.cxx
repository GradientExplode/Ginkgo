...
gkg::SmsVb15MultipleDifferentShellQSpaceSampling::
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    for ( s = 0; s < shellCount; s++ )
    {
      ...
      this->_orientationSets[ s ] = gkg::SmsVb15OrientationSet(
                                                      orientationCounts[ s ] );
  ...
  GKG_CATCH( "gkg::SmsVb15MultipleDifferentShellQSpaceSampling::"
             "SmsVb15MultipleDifferentShellQSpaceSampling( "
             "const std::vector< float >& shellBValues, "
             "const std::vector< int32_t >& orientationCounts, "
             "const gkg::HomogeneousTransform3d< float >& transform3d, "
...
void gkg::SmsVb15MultipleDifferentShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  GKG_CATCH( "void gkg::SmsVb15MultipleDifferentShellQSpaceSampling::"
