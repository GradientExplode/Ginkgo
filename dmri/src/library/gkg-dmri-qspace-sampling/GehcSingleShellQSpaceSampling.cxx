...
gkg::GehcSingleShellQSpaceSampling::GehcSingleShellQSpaceSampling(
                       float bValue,
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    this->_orientationSet = gkg::GehcOrientationSet( orientationCount );
  ...
  GKG_CATCH( "gkg::GehcSingleShellQSpaceSampling::"
...
void gkg::GehcSingleShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  try
  {
    ...
    headeredObject.getHeader().addAttribute(
                              ...
                              std::string( "spherical_single-shell_gehc" ) );
    headeredObject.getHeader().addAttribute(
                              "diffusion_sensitization_parameters",
                              diffusion_sensitization_parameters );

  }
  GKG_CATCH( "void gkg::GehcSingleShellQSpaceSampling::"
