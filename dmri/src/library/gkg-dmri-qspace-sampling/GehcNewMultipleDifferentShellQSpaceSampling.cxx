...
gkg::GehcNewMultipleDifferentShellQSpaceSampling::
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    for ( s = 0; s < shellCount; s++ )
    {
      ...
      this->_orientationSets[ s ] = gkg::GehcNewOrientationSet(
                                                      orientationCounts[ s ] );
  ...
  GKG_CATCH( "gkg::GehcNewMultipleDifferentShellQSpaceSampling::"
             "GehcNewMultipleDifferentShellQSpaceSampling( "
             "const std::vector< float >& shellBValues, "
             "const std::vector< int32_t >& orientationCounts, "
             "const gkg::HomogeneousTransform3d< float >& transform3d, "
...
void gkg::GehcNewMultipleDifferentShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  GKG_CATCH( "void gkg::GehcNewMultipleDifferentShellQSpaceSampling::"
