...
#include <gkg-processing-coordinates/GehcNewOrientationSet.h>
#include <gkg-core-object/GenericObject_i.h>
#include <gkg-core-exception/Exception.h>


gkg::GehcNewMultipleSameShellQSpaceSampling::
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    this->_orientationSets[ 0 ] = 
                                 gkg::GehcNewOrientationSet( orientationCount );
  ...
  GKG_CATCH( "gkg::GehcNewMultipleSameShellQSpaceSampling::"
             "GehcNewMultipleSameShellQSpaceSampling( "
             "const std::vector< float >& shellBValues, "
             "int32_t orientationCount, "
             "const gkg::HomogeneousTransform3d< float >& transform3d, "
...
void gkg::GehcNewMultipleSameShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  try
  {
    ...
    headeredObject.getHeader().addAttribute(
      ...
      std::string( "spherical_multiple-shell_same-orientation-set_gehc-new" ) );
    headeredObject.getHeader().addAttribute(
      "diffusion_sensitization_parameters",
      diffusion_sensitization_parameters );

  }
  GKG_CATCH( "void gkg::GehcNewMultipleSameShellQSpaceSampling::"
