...
#include <gkg-processing-coordinates/GehcOrientationSet.h>
#include <gkg-core-object/GenericObject_i.h>
#include <gkg-core-exception/Exception.h>


gkg::GehcMultipleSameShellQSpaceSampling::
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    this->_orientationSets[ 0 ] = gkg::GehcOrientationSet( orientationCount );
  ...
  GKG_CATCH( "gkg::GehcMultipleSameShellQSpaceSampling::"
             "GehcMultipleSameShellQSpaceSampling( "
             "const std::vector< float >& shellBValues, "
             "int32_t orientationCount, "
             "const gkg::HomogeneousTransform3d< float >& transform3d, "
...
gkg::GehcMultipleSameShellQSpaceSampling::~GehcMultipleSameShellQSpaceSampling()
{
}


void gkg::GehcMultipleSameShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  try
  {
    ...
    headeredObject.getHeader().addAttribute(
      ...
      std::string( "spherical_multiple-shell_same-orientation-set_gehc" ) );
    headeredObject.getHeader().addAttribute(
      "diffusion_sensitization_parameters",
      diffusion_sensitization_parameters );

  }
  GKG_CATCH( "void gkg::GehcMultipleSameShellQSpaceSampling::"
