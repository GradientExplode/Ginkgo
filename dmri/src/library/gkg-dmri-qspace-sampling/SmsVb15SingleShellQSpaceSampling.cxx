...
gkg::SmsVb15SingleShellQSpaceSampling::SmsVb15SingleShellQSpaceSampling(
                       float bValue,
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    this->_orientationSet = gkg::SmsVb15OrientationSet( orientationCount );
  ...
  GKG_CATCH( "gkg::SmsVb15SingleShellQSpaceSampling::"
...
void gkg::SmsVb15SingleShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  try
  {
    ...
    headeredObject.getHeader().addAttribute(
                              ...
                              std::string( "spherical_single-shell_smsvb15" ) );
    headeredObject.getHeader().addAttribute(
                              "diffusion_sensitization_parameters",
                              diffusion_sensitization_parameters );

  }
  GKG_CATCH( "void gkg::SmsVb15SingleShellQSpaceSampling::"
