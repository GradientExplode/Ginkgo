...
gkg::GehcNewSingleShellQSpaceSampling::GehcNewSingleShellQSpaceSampling(
                       float bValue,
                                                       ...
                                                       gradientCharacteristics )
{
  ...
  try
  {
    ...
    this->_orientationSet = gkg::GehcNewOrientationSet( orientationCount );
  ...
  GKG_CATCH( "gkg::GehcNewSingleShellQSpaceSampling::"
...
void gkg::GehcNewSingleShellQSpaceSampling::addInformationToHeader(
                                     gkg::HeaderedObject& headeredObject ) const
{
  ...
  try
  {
    ...
    headeredObject.getHeader().addAttribute(
                             ...
                             std::string( "spherical_single-shell_gehc-new" ) );
    headeredObject.getHeader().addAttribute(
                              "diffusion_sensitization_parameters",
                              diffusion_sensitization_parameters );

  }
  GKG_CATCH( "void gkg::GehcNewSingleShellQSpaceSampling::"
