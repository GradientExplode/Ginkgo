#ifndef _gkg_dmri_odf_functor_OdfFunctorMDScaledMaxNormalizedMesh_h_
#define _gkg_dmri_odf_functor_OdfFunctorMDScaledMaxNormalizedMesh_h_
...
class OdfFunctorMDScaledMaxNormalizedMesh :
                    public OdfFunctor< MeshMap< int32_t, float, 3U >,
                                       std::vector< float > >,
                    public Singleton< OdfFunctorMDScaledMaxNormalizedMesh >
{
  ...
  protected:
    ...
    friend class Singleton< OdfFunctorMDScaledMaxNormalizedMesh >;
