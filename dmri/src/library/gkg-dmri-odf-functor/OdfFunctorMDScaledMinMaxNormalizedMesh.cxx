#include <gkg-dmri-odf-functor/OdfFunctorMDScaledMinMaxNormalizedMesh.h>
...
gkg::OdfFunctorMDScaledMinMaxNormalizedMesh::
...
std::string gkg::OdfFunctorMDScaledMinMaxNormalizedMesh::getName() const
{

  return "md_scaled_minmax_normalized_mesh";

}


bool 
gkg::OdfFunctorMDScaledMinMaxNormalizedMesh::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorMDScaledMinMaxNormalizedMesh::process(
...
void gkg::OdfFunctorMDScaledMinMaxNormalizedMesh::processItem(
                 ...
                 const std::vector< std::string >& /*stringParameters*/ ) const
{
  ...
  GKG_CATCH( "void gkg::OdfFunctorMDScaledMinMaxNormalizedMesh::processItem( "
             "std::vector< float >& item, "
             "const gkg::OrientationDistributionFunction& odf, "
             "const std::vector< double >& scalarParameters, "
             "const std::vector< std::string >& /*stringParameters*/ ) "
...
static bool register_gkg_OdfFunctorMDScaledMinMaxNormalizedMesh 
                                                       __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::MeshMap< int32_t, float, 3U > ,
                        std::vector< float > >::getInstance().
                                                           registerOdfFunctor(
                 gkg::OdfFunctorMDScaledMinMaxNormalizedMesh::getInstance() );
