#ifndef _gkg_dmri_odf_functor_OdfFunctorMDGFAScaledMinMaxNormalizedMesh_h_
#define _gkg_dmri_odf_functor_OdfFunctorMDGFAScaledMinMaxNormalizedMesh_h_
...
class OdfFunctorMDGFAScaledMinMaxNormalizedMesh :
                    public OdfFunctor< MeshMap< int32_t, float, 3U >,
                                       std::vector< float > >,
                    public Singleton< OdfFunctorMDGFAScaledMinMaxNormalizedMesh >
{
  ...
  protected:
    ...
    friend class Singleton< OdfFunctorMDGFAScaledMinMaxNormalizedMesh >;
