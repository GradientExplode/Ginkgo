#ifndef _gkg_dmri_odf_functor_OdfFunctorGFAScaledMinMaxNormalizedMesh_h_
#define _gkg_dmri_odf_functor_OdfFunctorGFAScaledMinMaxNormalizedMesh_h_
...
class OdfFunctorGFAScaledMinMaxNormalizedMesh :
                    public OdfFunctor< MeshMap< int32_t, float, 3U >,
                                       std::vector< float > >,
                    public Singleton< OdfFunctorGFAScaledMinMaxNormalizedMesh >
{
  ...
  protected:
    ...
    friend class Singleton< OdfFunctorGFAScaledMinMaxNormalizedMesh >;
