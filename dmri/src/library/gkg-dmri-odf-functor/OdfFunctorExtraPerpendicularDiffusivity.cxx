#include <gkg-dmri-odf-functor/OdfFunctorExtraPerpendicularDiffusivity.h>
...
gkg::OdfFunctorExtraPerpendicularDiffusivity::OdfFunctorExtraPerpendicularDiffusivity()
...
std::string gkg::OdfFunctorExtraPerpendicularDiffusivity::getName() const
{

  return "extracellular_perpendicular_diffusivity";

}


bool gkg::OdfFunctorExtraPerpendicularDiffusivity::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorExtraPerpendicularDiffusivity::process(
...
/*
    ...
    if ( noddiOdfCartesianFieldFunctor )
    {
      ...
      output = noddiOdfCartesianFieldFunctor->
                                             getExtraPerpendicularDiffusivity();
      if ( verbose )
      {
...
*/
  ...
  GKG_CATCH( "void gkg::OdfFunctorExtraPerpendicularDiffusivity::process( "
             "gkg::Volume< float >& output, "
...
static bool register_gkg_OdfFunctorExtraPerpendicularDiffusivity
                                                       __attribute__((unused)) =
  gkg::OdfFunctorFactory< gkg::Volume< float >, float >::getInstance().
                                                             registerOdfFunctor(
                  gkg::OdfFunctorExtraPerpendicularDiffusivity::getInstance() );
