#ifndef _gkg_dmri_odf_functor_OdfFunctorMSDGFAScaledMinMaxNormalizedMesh_h_
#define _gkg_dmri_odf_functor_OdfFunctorMSDGFAScaledMinMaxNormalizedMesh_h_
...
class OdfFunctorMSDGFAScaledMinMaxNormalizedMesh :
                    public OdfFunctor< MeshMap< int32_t, float, 3U >,
                                       std::vector< float > >,
                    public Singleton< OdfFunctorMSDGFAScaledMinMaxNormalizedMesh >
{
  ...
  protected:
    ...
    friend class Singleton< OdfFunctorMSDGFAScaledMinMaxNormalizedMesh >;
