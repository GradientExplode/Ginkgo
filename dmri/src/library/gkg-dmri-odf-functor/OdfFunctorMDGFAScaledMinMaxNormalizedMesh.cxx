#include <gkg-dmri-odf-functor/OdfFunctorMDGFAScaledMinMaxNormalizedMesh.h>
...
gkg::OdfFunctorMDGFAScaledMinMaxNormalizedMesh::
                                      OdfFunctorMDGFAScaledMinMaxNormalizedMesh()
                                         : gkg::OdfFunctor<
...
std::string gkg::OdfFunctorMDGFAScaledMinMaxNormalizedMesh::getName() const
{

  return "mdgfa_scaled_minmax_normalized_mesh";

}


bool 
gkg::OdfFunctorMDGFAScaledMinMaxNormalizedMesh::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorMDGFAScaledMinMaxNormalizedMesh::process(
...
void gkg::OdfFunctorMDGFAScaledMinMaxNormalizedMesh::processItem(
                 ...
                 const std::vector< std::string >& /*stringParameters*/ ) const
{
  ...
  GKG_CATCH( "void gkg::OdfFunctorMDGFAScaledMinMaxNormalizedMesh::processItem( "
             "std::vector< float >& item, "
             "const gkg::OrientationDistributionFunction& odf, "
             "const std::vector< double >& scalarParameters, "
             "const std::vector< std::string >& /*stringParameters*/ ) "
...
static bool register_gkg_OdfFunctorMDGFAScaledMinMaxNormalizedMesh
                                                       __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::MeshMap< int32_t, float, 3U > ,
                        std::vector< float > >::getInstance().
                                                           registerOdfFunctor(
                gkg::OdfFunctorMDGFAScaledMinMaxNormalizedMesh::getInstance() );
