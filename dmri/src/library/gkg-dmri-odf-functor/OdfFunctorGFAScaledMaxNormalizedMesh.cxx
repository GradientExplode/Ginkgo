#include <gkg-dmri-odf-functor/OdfFunctorGFAScaledMaxNormalizedMesh.h>
...
gkg::OdfFunctorGFAScaledMaxNormalizedMesh::
...
std::string gkg::OdfFunctorGFAScaledMaxNormalizedMesh::getName() const
{

  return "gfa_scaled_max_normalized_mesh";

}


bool 
gkg::OdfFunctorGFAScaledMaxNormalizedMesh::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorGFAScaledMaxNormalizedMesh::process(
...
void gkg::OdfFunctorGFAScaledMaxNormalizedMesh::processItem(
                 ...
                 const std::vector< std::string >& /*stringParameters*/ ) const
{
  ...
  GKG_CATCH( "void gkg::OdfFunctorGFAScaledMaxNormalizedMesh::processItem( "
             "std::vector< float >& item, "
             "const gkg::OrientationDistributionFunction& odf, "
             "const std::vector< double >& scalarParameters, "
             "const std::vector< std::string >& /*stringParameters*/ ) "
...
static bool register_gkg_OdfFunctorGFAScaledMaxNormalizedMesh 
                                                       __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::MeshMap< int32_t, float, 3U > ,
                        std::vector< float > >::getInstance().
                                                           registerOdfFunctor(
                 gkg::OdfFunctorGFAScaledMaxNormalizedMesh::getInstance() );
