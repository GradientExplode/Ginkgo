#include <gkg-dmri-odf-functor/OdfFunctorParallelDiffusivity.h>
...
gkg::OdfFunctorParallelDiffusivity::OdfFunctorParallelDiffusivity()
...
std::string gkg::OdfFunctorParallelDiffusivity::getName() const
{

  return "parallel_diffusivity";

}


bool gkg::OdfFunctorParallelDiffusivity::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorParallelDiffusivity::process(
                         ...
                         bool verbose ) const
{
  ...
  try
  {
    ...
    if ( noddiOdfCartesianFieldFunctor )
    {
      ...
      output = noddiOdfCartesianFieldFunctor->getParallelDiffusivity();
      if ( verbose )
      {
  ...
  GKG_CATCH( "void gkg::OdfFunctorParallelDiffusivity::process( "
             "gkg::Volume< float >& output, "
...
static bool register_gkg_OdfFunctorParallelDiffusivity __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::Volume< float >, float >::getInstance().
                                                             registerOdfFunctor(
                            gkg::OdfFunctorParallelDiffusivity::getInstance() );
