#include <gkg-dmri-odf-functor/OdfFunctorMSDGFAScaledMaxNormalizedMesh.h>
...
gkg::OdfFunctorMSDGFAScaledMaxNormalizedMesh::
...
std::string gkg::OdfFunctorMSDGFAScaledMaxNormalizedMesh::getName() const
{

  return "msdgfa_scaled_max_normalized_mesh";

}


bool 
gkg::OdfFunctorMSDGFAScaledMaxNormalizedMesh::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorMSDGFAScaledMaxNormalizedMesh::process(
...
void gkg::OdfFunctorMSDGFAScaledMaxNormalizedMesh::processItem(
                 ...
                 const std::vector< std::string >& /*stringParameters*/ ) const
{
  ...
  GKG_CATCH( "void gkg::OdfFunctorMSDGFAScaledMaxNormalizedMesh::processItem( "
             "std::vector< float >& item, "
             "const gkg::OrientationDistributionFunction& odf, "
             "const std::vector< double >& scalarParameters, "
             "const std::vector< std::string >& /*stringParameters*/ ) "
...
static bool register_gkg_OdfFunctorMSDGFAScaledMaxNormalizedMesh
                                                       __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::MeshMap< int32_t, float, 3U > ,
                        std::vector< float > >::getInstance().
                                                           registerOdfFunctor(
                 gkg::OdfFunctorMSDGFAScaledMaxNormalizedMesh::getInstance() );
