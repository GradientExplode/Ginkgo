#include <gkg-dmri-odf-functor/OdfFunctorMSDGFAScaledMinMaxNormalizedMesh.h>
...
gkg::OdfFunctorMSDGFAScaledMinMaxNormalizedMesh::
                                      OdfFunctorMSDGFAScaledMinMaxNormalizedMesh()
                                         : gkg::OdfFunctor<
...
std::string gkg::OdfFunctorMSDGFAScaledMinMaxNormalizedMesh::getName() const
{

  return "msdgfa_scaled_minmax_normalized_mesh";

}


bool 
gkg::OdfFunctorMSDGFAScaledMinMaxNormalizedMesh::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorMSDGFAScaledMinMaxNormalizedMesh::process(
                             ...
                             bool verbose ) const
{
  ...
  try
  {
    ...
    gkg::OdfFunctorFactory< gkg::Volume< float >, float >::getInstance().
          getOdfFunctor( "normalized_mean_squared_displacement" ).process(
...
void gkg::OdfFunctorMSDGFAScaledMinMaxNormalizedMesh::processItem(
                 ...
                 const std::vector< std::string >& /*stringParameters*/ ) const
{
  ...
  GKG_CATCH( "void gkg::OdfFunctorMSDGFAScaledMinMaxNormalizedMesh::processItem( "
             "std::vector< float >& item, "
             "const gkg::OrientationDistributionFunction& odf, "
             "const std::vector< double >& scalarParameters, "
             "const std::vector< std::string >& /*stringParameters*/ ) "
...
static bool register_gkg_OdfFunctorMSDGFAScaledMinMaxNormalizedMesh 
                                                       __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::MeshMap< int32_t, float, 3U > ,
                        std::vector< float > >::getInstance().
                                                           registerOdfFunctor(
                 gkg::OdfFunctorMSDGFAScaledMinMaxNormalizedMesh::getInstance() );
