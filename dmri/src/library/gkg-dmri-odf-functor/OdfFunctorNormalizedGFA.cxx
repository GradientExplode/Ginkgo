#include <gkg-dmri-odf-functor/OdfFunctorNormalizedGFA.h>
...
gkg::OdfFunctorNormalizedGFA::OdfFunctorNormalizedGFA()
...
std::string gkg::OdfFunctorNormalizedGFA::getName() const
{
...
bool gkg::OdfFunctorNormalizedGFA::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorNormalizedGFA::process(
                             ...
                             bool verbose ) const
{
  ...
  try
  {
    ...
    gkg::OdfFunctorFactory< gkg::Volume< float >, float >::getInstance().
          getOdfFunctor( "gfa" ).process( output,
                                          odfCartesianField,
                                          scalarParameters,
                                          stringParameters,
                                          false );
...
static bool register_gkg_OdfFunctorNormalizedGFA __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::Volume< float >, float >::getInstance().
                                                           registerOdfFunctor(
                                  gkg::OdfFunctorNormalizedGFA::getInstance() );
