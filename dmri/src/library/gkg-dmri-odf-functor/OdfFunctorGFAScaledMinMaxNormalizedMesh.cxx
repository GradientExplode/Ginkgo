#include <gkg-dmri-odf-functor/OdfFunctorGFAScaledMinMaxNormalizedMesh.h>
...
gkg::OdfFunctorGFAScaledMinMaxNormalizedMesh::
                                      OdfFunctorGFAScaledMinMaxNormalizedMesh()
                                             : gkg::OdfFunctor<
...
std::string gkg::OdfFunctorGFAScaledMinMaxNormalizedMesh::getName() const
{

  return "gfa_scaled_minmax_normalized_mesh";

}


bool 
gkg::OdfFunctorGFAScaledMinMaxNormalizedMesh::isStandardBasisRequired() const
{
...
void gkg::OdfFunctorGFAScaledMinMaxNormalizedMesh::process(
...
void gkg::OdfFunctorGFAScaledMinMaxNormalizedMesh::processItem(
                 ...
                 const std::vector< std::string >& /*stringParameters*/ ) const
{
  ...
  GKG_CATCH( "void gkg::OdfFunctorGFAScaledMinMaxNormalizedMesh::processItem( "
             "std::vector< float >& item, "
             "const gkg::OrientationDistributionFunction& odf, "
             "const std::vector< double >& scalarParameters, "
             "const std::vector< std::string >& /*stringParameters*/ ) "
...
static bool register_gkg_OdfFunctorGFAScaledMinMaxNormalizedMesh 
                                                       __attribute__((unused)) =
gkg::OdfFunctorFactory< gkg::MeshMap< int32_t, float, 3U > ,
                        std::vector< float > >::getInstance().
                                                           registerOdfFunctor(
                 gkg::OdfFunctorGFAScaledMinMaxNormalizedMesh::getInstance() );
