#ifndef _gkg_dmri_container_BundleMeasureSpreadSheet_h_
#define _gkg_dmri_container_BundleMeasureSpreadSheet_h_
...
class BundleMeasureSpreadSheet : public HeaderedObject
{
  ...
  public:
    ...
    BundleMeasureSpreadSheet( RCPointer< BundleMap< L, Compare > > bundleMap );
    BundleMeasureSpreadSheet(
                          const BundleMeasureSpreadSheet< L, Compare >& other );
    virtual ~BundleMeasureSpreadSheet();

    BundleMeasureSpreadSheet< L, Compare >& operator=(
                          const BundleMeasureSpreadSheet< L, Compare >& other );
  ...
  protected:
    ...
    // _measures[ bundle_label ][ measure_name ]
    std::map< L,
              std::map< std::string, Matrix >,
              Compare > _measures;
