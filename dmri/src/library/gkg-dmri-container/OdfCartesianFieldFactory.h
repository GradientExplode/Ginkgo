#ifndef _gkg_dmri_container_OdfCartesianFieldFactory_h_
#define _gkg_dmri_container_OdfCartesianFieldFactory_h_
...
class OdfCartesianFieldFactory : public Singleton< OdfCartesianFieldFactory >
{
  ...
  public:
    ...
    template < class F >
    static OdfCartesianField* createOdfCartesianField( 
                    RCPointer< Volume< float > > t2,
                    RCPointer< Volume< float > > dw,
                    RCPointer< Volume< int16_t > > mask,
                    const std::vector< int32_t >& iBox,
  ...
  protected:
    ...
    friend class Singleton< OdfCartesianFieldFactory >;
