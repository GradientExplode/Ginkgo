#ifndef _gkg_dmri_connectivity_matrix_MeshToMeshAndTextureConnectivityMatrixFunctor_h_
#define _gkg_dmri_connectivity_matrix_MeshToMeshAndTextureConnectivityMatrixFunctor_h_
...
class MeshToMeshAndTextureConnectivityMatrixFunctor :
     public ConnectivityMatrixFunctor< L, Compare >,
     public Creator2Arg< MeshToMeshAndTextureConnectivityMatrixFunctor< L, 
                                                                      Compare >,
...

{
  ...
  protected:
    ...
    friend 
    class Creator2Arg< MeshToMeshAndTextureConnectivityMatrixFunctor< L, 
                                                                      Compare >,
                       ConnectivityMatrixFunctor< L, Compare >,
                       const std::vector< double >&,
                       const std::vector< std::string >& >;
