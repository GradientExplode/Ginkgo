...
template < class T >
gkg::BundleFromVolumeProfileAlongCentroid< T >::
           ...
           const T& background )
                          : gkg::BundleMeasure< std::vector< T > >(),
...
template < class T >
void gkg::BundleFromVolumeProfileAlongCentroid< T >::setCentroidLabel(
                                                      const std::string& label )
{
  ...
  GKG_CATCH( "template < class T > "
             "void gkg::BundleFromVolumeProfileAlongCentroid< T >::"
...
template < class T >
std::vector< T > gkg::BundleFromVolumeProfileAlongCentroid< T >::get(
    const typename gkg::BundleFromVolumeProfileAlongCentroid< T >::Bundle&
                                                                 bundle ) const
{
  ...
  {    
    ...
    std::vector< double > profileDouble( sectionCount, 0.0 );
    std::vector< int32_t > count( sectionCount, 0 );
    ...
    if ( _maskVolume.isNull() )
    {
      ...
      typename
      gkg::BundleFromVolumeProfileAlongCentroid< T >::Bundle::const_iterator
        f = bundle.begin(),
        fe = bundle.end();
      while ( f != fe )
      {
    ...
    // allocating profile
    std::vector< T > profile( sectionCount, ( T )0 );
    ...
    for ( p = 0; p < sectionCount; p++ )
    {
      ...
      if ( count[ p ] )
      {
        ...
        profile[ p ] = ( T )( profileDouble[ p ] / ( double )count[ p ] );
  ...
  GKG_CATCH( "template < class T >"
             "std::vector< T > "
             "gkg::BundleFromVolumeProfileAlongCentroid< T >::get( "
             "const typename "
             "gkg::BundleFromVolumeProfileAlongCentroid< T >::Bundle& "
             "bundle ) const" );
...
void gkg::BundleFromVolumeProfileAlongCentroid< T >::spreadSheetFunctor(
                      ...
                      Compare >& measures )
{
  ...
  try
  {
    ...
    gkg::BundleFromVolumeProfileAlongCentroid< T >
    bundleFromVolumeProfileAlongCentroid( centroids,
                                          labelToIndexLut,
                                          sectionVolume,
                                          sectionCounts,
                                          scalarVolume,
    ...
    while ( l != le )
    {
      ...
      bundleFromVolumeProfileAlongCentroid.setCentroidLabel( 
                                     gkg::StringConverter::toString( label ) );
      std::vector< T > fromVolumeProfileAlongCentroid =
                             bundleFromVolumeProfileAlongCentroid.get( bundle );

      int32_t size = ( int32_t )fromVolumeProfileAlongCentroid.size();
      gkg::Matrix measure( 1, size );
      int32_t p = 0;
      for ( p = 0; p < size; p++ )
      {

        measure( 0, p ) = ( double )fromVolumeProfileAlongCentroid[ p ];

      }

      measures[ label ][ "from_volume_profile_along_centroid" ] = measure;
...
template class gkg::BundleFromVolumeProfileAlongCentroid< int8_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< uint8_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< int16_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< uint16_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< int32_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< uint32_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< int64_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< uint64_t >;
template class gkg::BundleFromVolumeProfileAlongCentroid< float >;
template class gkg::BundleFromVolumeProfileAlongCentroid< double >;
...
static bool initializeBundleFromVolumeProfileAlongCentroidChecker()
{
  ...
  GKG_CATCH( "static bool "
             "initializeBundleFromVolumeProfileAlongCentroidChecker()" );
