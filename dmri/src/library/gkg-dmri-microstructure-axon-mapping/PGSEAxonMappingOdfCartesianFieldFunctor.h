#ifndef _gkg_dmri_microstructure_axon_mapping_PGSEAxonMappingOdfCartesianFieldFunctor_h_
#define _gkg_dmri_microstructure_axon_mapping_PGSEAxonMappingOdfCartesianFieldFunctor_h_
...
class PGSEAxonMappingOdfCartesianFieldFunctor :
        public DiffusionCartesianFieldFunctor< OrientationDistributionFunction >
{
  ...
  public:
    ...
    virtual ~PGSEAxonMappingOdfCartesianFieldFunctor();
