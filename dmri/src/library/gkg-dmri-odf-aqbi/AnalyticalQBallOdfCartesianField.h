#ifndef _gkg_dmri_odf_aqbi_AnalyticalQBallOdfCartesianField_h_
#define _gkg_dmri_odf_aqbi_AnalyticalQBallOdfCartesianField_h_
...
class AnalyticalQBallOdfCartesianField : public OdfCartesianField
{
  ...
  public:
    ...
    AnalyticalQBallOdfCartesianField(
                     ...
                     const std::vector< std::string >& specificStringParameters,
                     bool verbose = false );
    virtual ~AnalyticalQBallOdfCartesianField();
