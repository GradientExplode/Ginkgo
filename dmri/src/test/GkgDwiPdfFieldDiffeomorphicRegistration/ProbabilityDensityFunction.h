...
class ProbabilityDensityFunction : public DiffusionFeature
{
  ...
  public:
    ...
    virtual void finiteStrainReorientation( 
                                    gkg::Matrix& jacobianMatrix,
                                    gkg::ProbabilityDensityFunction& otherPdf );

    virtual void affineReorientation( 
                                    gkg::Matrix& jacobianMatrix,
                                    gkg::ProbabilityDensityFunction& otherPdf );
    ...
    virtual double dot( const ProbabilityDensityFunction& other ) const;

    virtual float getDissimilarity( const ProbabilityDensityFunction& other,
                                    float orientationWeight = 1.0f,
                                    float shapeWeight = 1.0f ) const;
