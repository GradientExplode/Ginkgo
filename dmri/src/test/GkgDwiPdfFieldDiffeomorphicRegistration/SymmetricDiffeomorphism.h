                ...
                gkg::Volume< float >& J33 )
{
  ...
  try
  {
    ...
    std::cout << "Jacobian of deformations| Mean (std): "
              << std::round( jmean * 1000 ) / 1000.0 
              << " (" << round( jstd * 1000 ) / 1000.0 << ")\n";
    std::cout << "Range: [" << Jmin << ", " << Jmax 
              << "] Negative fraction: "<< frac << "\n";

    return std::round( jmean * 1000 ) / 1000.0;
...
void jacobianMatrices( gkg::Volume< float >& flowFieldX,
                        gkg::Volume< float >& flowFieldY,
                        gkg::Volume< float >& flowFieldZ,
                        gkg::Volume< float >& J11,
                        gkg::Volume< float >& J12,
                        ...
                        int32_t factor )
{
  ...
  GKG_CATCH( "void jacobianMatrices( gkg::Volume< float >& flowFieldX,"
             "gkg::Volume< float >& flowFieldY,"
             "gkg::Volume< float >& flowFieldZ,"
             "gkg::Volume< float >& J11,"
             "gkg::Volume< float >& J12,"
