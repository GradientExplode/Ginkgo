...
gkg::SpinGlassCreationInformationCallback::SpinGlassCreationInformationCallback(
                                                 void* parameter, bool verbose )
                              : gkg::RpcCallback(
                                  gkg::SPIN_GLASS_CREATION_INFORMATION_CALLBACK,
                                  parameter ),
...
gkg::SpinGlassCreationInformationCallback::
                                         ~SpinGlassCreationInformationCallback()
{
}


void gkg::SpinGlassCreationInformationCallback::receive(
                                                     gkg::SocketStream& stream )
{
  ...
  try
  {
    ...
    if ( globalTractographyService )
    {
      ...
      globalTractographyOptimizationInformation->setCreationCount(
        globalTractographyOptimizationInformation->getLastCreationCount() + 1 );
      globalTractographyService->postEvent( GT_PARAMETER_OFFSET +
                                            GT_PARAMETER_CREATION_COUNT );
      globalTractographyService->postEvent( GT_PLOT_OFFSET +
                                            GT_PARAMETER_CREATION_COUNT );
  ...
  GKG_CATCH( "void gkg::SpinGlassCreationInformationCallback::receive( "
             "gkg::SocketStream& stream )" );
