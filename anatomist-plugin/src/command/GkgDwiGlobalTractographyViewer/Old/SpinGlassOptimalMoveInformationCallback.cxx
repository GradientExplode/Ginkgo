...
gkg::SpinGlassOptimalMoveInformationCallback::
                                        SpinGlassOptimalMoveInformationCallback(
                                                 void* parameter, bool verbose )
                          : gkg::RpcCallback(
                              gkg::SPIN_GLASS_OPTIMAL_MOVE_INFORMATION_CALLBACK,
                              parameter ),
...
void gkg::SpinGlassOptimalMoveInformationCallback::receive(
                                                     gkg::SocketStream& stream )
{
  ...
  try
  {
    ...
    if ( globalTractographyService )
    {
      ...
      ///////// optimal move count /////////////////////////////////////////////
      globalTractographyOptimizationInformation->
        setOptimalMoveCount( globalTractographyOptimizationInformation->
                                                getLastOptimalMoveCount() + 1 );
      globalTractographyService->postEvent( GT_PARAMETER_OFFSET +
                                            GT_PARAMETER_OPTIMAL_MOVE_COUNT );
      globalTractographyService->postEvent( GT_PLOT_OFFSET +
                                            GT_PARAMETER_OPTIMAL_MOVE_COUNT );
  ...
  GKG_CATCH( "void gkg::SpinGlassOptimalMoveInformationCallback::receive( "
             "gkg::SocketStream& stream )" );
